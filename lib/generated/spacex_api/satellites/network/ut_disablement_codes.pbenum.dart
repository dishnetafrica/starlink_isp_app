...
class UtDisablementCode extends $pb.ProtobufEnum {
  ...
  static const UtDisablementCode MOVING_TOO_FAST_FOR_POLICY = UtDisablementCode._(14, _omitEnumNames ? '' : 'MOVING_TOO_FAST_FOR_POLICY');
  static const UtDisablementCode UNDER_AVIATION_FLYOVER_LIMITS = UtDisablementCode._(15, _omitEnumNames ? '' : 'UNDER_AVIATION_FLYOVER_LIMITS');
  static const UtDisablementCode BLOCKED_AREA = UtDisablementCode._(16, _omitEnumNames ? '' : 'BLOCKED_AREA');
...
class AccountDisablementReason extends $pb.ProtobufEnum {
  static const AccountDisablementReason NO_RESTRICTION = AccountDisablementReason._(0, _omitEnumNames ? '' : 'NO_RESTRICTION');
  static const AccountDisablementReason KNOW_YOUR_CUSTOMER_REQUIRED = AccountDisablementReason._(1, _omitEnumNames ? '' : 'KNOW_YOUR_CUSTOMER_REQUIRED');

  static const $core.List<AccountDisablementReason> values = <AccountDisablementReason> [
    NO_RESTRICTION,
    KNOW_YOUR_CUSTOMER_REQUIRED,
  ];

  static final $core.Map<$core.int, AccountDisablementReason> _byValue = $pb.ProtobufEnum.initByValue(values);
  static AccountDisablementReason? valueOf($core.int value) => _byValue[value];

  const AccountDisablementReason._($core.int v, $core.String n) : super(v, n);
}
