...
class CalibrationPartitionsState extends $pb.ProtobufEnum {
  static const CalibrationPartitionsState CALIBRATION_PARTITIONS_STATE_UNSPECIFIED = CalibrationPartitionsState._(0, _omitEnumNames ? '' : 'CALIBRATION_PARTITIONS_STATE_UNSPECIFIED');
  static const CalibrationPartitionsState CALIBRATION_PARTITIONS_STATE_ABSENT_BOTH_SIDES = CalibrationPartitionsState._(1, _omitEnumNames ? '' : 'CALIBRATION_PARTITIONS_STATE_ABSENT_BOTH_SIDES');
  static const CalibrationPartitionsState CALIBRATION_PARTITIONS_STATE_CONTENTS_EQUAL = CalibrationPartitionsState._(2, _omitEnumNames ? '' : 'CALIBRATION_PARTITIONS_STATE_CONTENTS_EQUAL');
  static const CalibrationPartitionsState CALIBRATION_PARTITIONS_STATE_CONTENTS_NOT_EQUAL = CalibrationPartitionsState._(3, _omitEnumNames ? '' : 'CALIBRATION_PARTITIONS_STATE_CONTENTS_NOT_EQUAL');
  static const CalibrationPartitionsState CALIBRATION_PARTITIONS_STATE_COMPARISON_FAILED = CalibrationPartitionsState._(4, _omitEnumNames ? '' : 'CALIBRATION_PARTITIONS_STATE_COMPARISON_FAILED');

  static const $core.List<CalibrationPartitionsState> values = <CalibrationPartitionsState> [
  ...
  static final $core.Map<$core.int, CalibrationPartitionsState> _byValue = $pb.ProtobufEnum.initByValue(values);
  static CalibrationPartitionsState? valueOf($core.int value) => _byValue[value];

  const CalibrationPartitionsState._($core.int v, $core.String n) : super(v, n);
}
