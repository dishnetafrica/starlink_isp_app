...
class TransceiverGetStatusResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransceiverGetStatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ...
    ..e<$11.DishState>(1006, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $11.DishState.UNKNOWN, valueOf: $11.DishState.valueOf, enumValues: $11.DishState.values)
  ...
  @$pb.TagNumber(1006)
  $11.DishState get state => $_getN(4);
  @$pb.TagNumber(1006)
  set state($11.DishState v) { setField(1006, v); }
  @$pb.TagNumber(1006)
