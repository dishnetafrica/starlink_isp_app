...
import '../common/status/status.pb.dart' as $17;
import 'command.pb.dart' as $3;
import 'common.pb.dart' as $4;
import 'device.pbenum.dart';
import 'dish.pb.dart' as $11;
import 'dish.pbenum.dart' as $11;
import 'services/unlock/service.pb.dart' as $1;
import 'transceiver.pb.dart' as $16;
...
class Request extends $pb.GeneratedMessage {
  factory Request({
    ...
    $4.SignedData? signedRequest,
    RebootRequest? reboot,
    SpeedTestRequest? speedTest,
    GetStatusRequest? getStatus,
    $4.AuthenticateRequest? authenticate,
    $4.GetNextIdRequest? getNextId,
    ...
    $4.InitiateRemoteSshRequest? initiateRemoteSsh,
    $11.SelfTestRequest? selfTest,
    $11.SetTestModeRequest? setTestMode,
    $4.SoftwareUpdateRequest? softwareUpdate,
    ...
    $4.SignedData? sensitiveRequest,
    $11.DishStowRequest? dishStow,
    $11.DishGetContextRequest? dishGetContext,
    DishSetEmcRequest? dishSetEmc,
    $11.DishGetObstructionMapRequest? dishGetObstructionMap,
    DishGetEmcRequest? dishGetEmc,
    $11.DishSetConfigRequest? dishSetConfig,
    $11.DishGetConfigRequest? dishGetConfig,
    DishPowerSaveRequest? dishPowerSave,
    $11.DishInhibitGpsRequest? dishInhibitGps,
    $11.DishGetDataRequest? dishGetData,
    $11.DishClearObstructionMapRequest? dishClearObstructionMap,
    DishSetMaxPowerTestModeRequest? dishSetMaxPowerTestMode,
    $11.DishActivateRssiScanRequest? dishActivateRssiScan,
    $11.DishGetRssiScanResultRequest? dishGetRssiScanResult,
    $11.DishFactoryResetRequest? dishFactoryReset,
    $11.ResetButtonRequest? resetButton,
    $4.SoftwareUpdateRequest? setPerVehicleConfig,
    $11.DishAviationTestRequest? dishAviationTest,
    $11.DishInhibitRfRequest? dishInhibitRf,
    ...
    $0.WifiRunDebugNetsysRequest? wifiRunDebugNetsys,
    $0.WifiResetEthPhyRequest? wifiResetEthPhy,
    $0.WifiFlushHardwareNatRequest? wifiFlushHardwareNat,
    WifiWriteCalibrationRequest? wifiWriteCalibration,
    $16.TransceiverIFLoopbackTestRequest? transceiverIfLoopbackTest,
    $16.TransceiverGetStatusRequest? transceiverGetStatus,
    $16.TransceiverGetTelemetryRequest? transceiverGetTelemetry,
    ...
    if (dishAviationTest != null) {
      $result.dishAviationTest = dishAviationTest;
    }
    if (dishInhibitRf != null) {
      $result.dishInhibitRf = dishInhibitRf;
    }
    ...
    if (wifiResetEthPhy != null) {
      $result.wifiResetEthPhy = wifiResetEthPhy;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..oo(0, [15, 1001, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1019, 1020, 1021, 1022, 1023, 1027, 1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 1037, 1038, 1039, 1040, 1041, 1078, 2002, 2003, 2007, 2008, 2009, 2010, 2011, 2013, 2014, 2015, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2026, 3001, 3002, 3003, 3007, 3009, 3012, 3013, 3015, 3016, 3017, 3018, 3019, 3020, 3021, 3024, 3025, 3026, 3027, 3028, 3029, 3030, 3031, 3032, 3033, 3034, 3035, 4001, 4003, 4004, 5000, 5001, 6000])
    ...
    ..aOM<$4.SignedData>(15, _omitFieldNames ? '' : 'signedRequest', subBuilder: $4.SignedData.create)
    ...
    ..aOM<$4.AuthenticateRequest>(1005, _omitFieldNames ? '' : 'authenticate', subBuilder: $4.AuthenticateRequest.create)
    ..aOM<$4.GetNextIdRequest>(1006, _omitFieldNames ? '' : 'getNextId', subBuilder: $4.GetNextIdRequest.create)
    ...
    ..aOM<$4.InitiateRemoteSshRequest>(1030, _omitFieldNames ? '' : 'initiateRemoteSsh', subBuilder: $4.InitiateRemoteSshRequest.create)
    ..aOM<$11.SelfTestRequest>(1031, _omitFieldNames ? '' : 'selfTest', subBuilder: $11.SelfTestRequest.create)
    ..aOM<$11.SetTestModeRequest>(1032, _omitFieldNames ? '' : 'setTestMode', subBuilder: $11.SetTestModeRequest.create)
    ..aOM<$4.SoftwareUpdateRequest>(1033, _omitFieldNames ? '' : 'softwareUpdate', subBuilder: $4.SoftwareUpdateRequest.create)
    ...
    ..aOM<GetGoroutineStackTracesRequest>(1041, _omitFieldNames ? '' : 'getGoroutineStackTraces', subBuilder: GetGoroutineStackTracesRequest.create)
    ..aOM<$4.SignedData>(1078, _omitFieldNames ? '' : 'sensitiveRequest', subBuilder: $4.SignedData.create)
    ..aOM<$11.DishStowRequest>(2002, _omitFieldNames ? '' : 'dishStow', subBuilder: $11.DishStowRequest.create)
    ..aOM<$11.DishGetContextRequest>(2003, _omitFieldNames ? '' : 'dishGetContext', subBuilder: $11.DishGetContextRequest.create)
    ..aOM<DishSetEmcRequest>(2007, _omitFieldNames ? '' : 'dishSetEmc', subBuilder: DishSetEmcRequest.create)
    ..aOM<$11.DishGetObstructionMapRequest>(2008, _omitFieldNames ? '' : 'dishGetObstructionMap', subBuilder: $11.DishGetObstructionMapRequest.create)
    ..aOM<DishGetEmcRequest>(2009, _omitFieldNames ? '' : 'dishGetEmc', subBuilder: DishGetEmcRequest.create)
    ..aOM<$11.DishSetConfigRequest>(2010, _omitFieldNames ? '' : 'dishSetConfig', subBuilder: $11.DishSetConfigRequest.create)
    ..aOM<$11.DishGetConfigRequest>(2011, _omitFieldNames ? '' : 'dishGetConfig', subBuilder: $11.DishGetConfigRequest.create)
    ..aOM<DishPowerSaveRequest>(2013, _omitFieldNames ? '' : 'dishPowerSave', subBuilder: DishPowerSaveRequest.create)
    ..aOM<$11.DishInhibitGpsRequest>(2014, _omitFieldNames ? '' : 'dishInhibitGps', subBuilder: $11.DishInhibitGpsRequest.create)
    ..aOM<$11.DishGetDataRequest>(2015, _omitFieldNames ? '' : 'dishGetData', subBuilder: $11.DishGetDataRequest.create)
    ..aOM<$11.DishClearObstructionMapRequest>(2017, _omitFieldNames ? '' : 'dishClearObstructionMap', subBuilder: $11.DishClearObstructionMapRequest.create)
    ...
    ..aOM<$11.DishActivateRssiScanRequest>(2019, _omitFieldNames ? '' : 'dishActivateRssiScan', subBuilder: $11.DishActivateRssiScanRequest.create)
    ..aOM<$11.DishGetRssiScanResultRequest>(2020, _omitFieldNames ? '' : 'dishGetRssiScanResult', subBuilder: $11.DishGetRssiScanResultRequest.create)
    ..aOM<$11.DishFactoryResetRequest>(2021, _omitFieldNames ? '' : 'dishFactoryReset', subBuilder: $11.DishFactoryResetRequest.create)
    ..aOM<$11.ResetButtonRequest>(2022, _omitFieldNames ? '' : 'resetButton', subBuilder: $11.ResetButtonRequest.create)
    ..aOM<$4.SoftwareUpdateRequest>(2023, _omitFieldNames ? '' : 'setPerVehicleConfig', subBuilder: $4.SoftwareUpdateRequest.create)
    ..aOM<$11.DishAviationTestRequest>(2024, _omitFieldNames ? '' : 'dishAviationTest', subBuilder: $11.DishAviationTestRequest.create)
    ..aOM<$11.DishInhibitRfRequest>(2026, _omitFieldNames ? '' : 'dishInhibitRf', subBuilder: $11.DishInhibitRfRequest.create)
    ...
    ..aOM<WifiClientSandboxRequest>(3031, _omitFieldNames ? '' : 'wifiClientSandbox', subBuilder: WifiClientSandboxRequest.create)
    ..aOM<$0.WifiRunDebugNetsysRequest>(3032, _omitFieldNames ? '' : 'wifiRunDebugNetsys', subBuilder: $0.WifiRunDebugNetsysRequest.create)
    ..aOM<$0.WifiResetEthPhyRequest>(3033, _omitFieldNames ? '' : 'wifiResetEthPhy', subBuilder: $0.WifiResetEthPhyRequest.create)
    ..aOM<$0.WifiFlushHardwareNatRequest>(3034, _omitFieldNames ? '' : 'wifiFlushHardwareNat', subBuilder: $0.WifiFlushHardwareNatRequest.create)
    ..aOM<WifiWriteCalibrationRequest>(3035, _omitFieldNames ? '' : 'wifiWriteCalibration', subBuilder: WifiWriteCalibrationRequest.create)
    ..aOM<$16.TransceiverIFLoopbackTestRequest>(4001, _omitFieldNames ? '' : 'transceiverIfLoopbackTest', subBuilder: $16.TransceiverIFLoopbackTestRequest.create)
    ..aOM<$16.TransceiverGetStatusRequest>(4003, _omitFieldNames ? '' : 'transceiverGetStatus', subBuilder: $16.TransceiverGetStatusRequest.create)
    ..aOM<$16.TransceiverGetTelemetryRequest>(4004, _omitFieldNames ? '' : 'transceiverGetTelemetry', subBuilder: $16.TransceiverGetTelemetryRequest.create)
  ...
  @$pb.TagNumber(15)
  $4.SignedData get signedRequest => $_getN(3);
  @$pb.TagNumber(15)
  set signedRequest($4.SignedData v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasSignedRequest() => $_has(3);
  @$pb.TagNumber(15)
  void clearSignedRequest() => clearField(15);
  @$pb.TagNumber(15)
  $4.SignedData ensureSignedRequest() => $_ensure(3);
  ...
  @$pb.TagNumber(1005)
  $4.AuthenticateRequest get authenticate => $_getN(7);
  @$pb.TagNumber(1005)
  set authenticate($4.AuthenticateRequest v) { setField(1005, v); }
  @$pb.TagNumber(1005)
  $core.bool hasAuthenticate() => $_has(7);
  @$pb.TagNumber(1005)
  void clearAuthenticate() => clearField(1005);
  @$pb.TagNumber(1005)
  $4.AuthenticateRequest ensureAuthenticate() => $_ensure(7);

  @$pb.TagNumber(1006)
  $4.GetNextIdRequest get getNextId => $_getN(8);
  @$pb.TagNumber(1006)
  set getNextId($4.GetNextIdRequest v) { setField(1006, v); }
  @$pb.TagNumber(1006)
  $core.bool hasGetNextId() => $_has(8);
  @$pb.TagNumber(1006)
  void clearGetNextId() => clearField(1006);
  @$pb.TagNumber(1006)
  $4.GetNextIdRequest ensureGetNextId() => $_ensure(8);
  ...
  @$pb.TagNumber(1030)
  $4.InitiateRemoteSshRequest get initiateRemoteSsh => $_getN(28);
  @$pb.TagNumber(1030)
  set initiateRemoteSsh($4.InitiateRemoteSshRequest v) { setField(1030, v); }
  @$pb.TagNumber(1030)
  $core.bool hasInitiateRemoteSsh() => $_has(28);
  @$pb.TagNumber(1030)
  void clearInitiateRemoteSsh() => clearField(1030);
  @$pb.TagNumber(1030)
  $4.InitiateRemoteSshRequest ensureInitiateRemoteSsh() => $_ensure(28);

  @$pb.TagNumber(1031)
  $11.SelfTestRequest get selfTest => $_getN(29);
  @$pb.TagNumber(1031)
  set selfTest($11.SelfTestRequest v) { setField(1031, v); }
  @$pb.TagNumber(1031)
  $core.bool hasSelfTest() => $_has(29);
  @$pb.TagNumber(1031)
  void clearSelfTest() => clearField(1031);
  @$pb.TagNumber(1031)
  $11.SelfTestRequest ensureSelfTest() => $_ensure(29);

  @$pb.TagNumber(1032)
  $11.SetTestModeRequest get setTestMode => $_getN(30);
  @$pb.TagNumber(1032)
  set setTestMode($11.SetTestModeRequest v) { setField(1032, v); }
  @$pb.TagNumber(1032)
  $core.bool hasSetTestMode() => $_has(30);
  @$pb.TagNumber(1032)
  void clearSetTestMode() => clearField(1032);
  @$pb.TagNumber(1032)
  $11.SetTestModeRequest ensureSetTestMode() => $_ensure(30);

  @$pb.TagNumber(1033)
  $4.SoftwareUpdateRequest get softwareUpdate => $_getN(31);
  @$pb.TagNumber(1033)
  set softwareUpdate($4.SoftwareUpdateRequest v) { setField(1033, v); }
  @$pb.TagNumber(1033)
  $core.bool hasSoftwareUpdate() => $_has(31);
  @$pb.TagNumber(1033)
  void clearSoftwareUpdate() => clearField(1033);
  @$pb.TagNumber(1033)
  $4.SoftwareUpdateRequest ensureSoftwareUpdate() => $_ensure(31);
  ...
  @$pb.TagNumber(1041)
  set getGoroutineStackTraces(GetGoroutineStackTracesRequest v) { setField(1041, v); }
  @$pb.TagNumber(1041)
  $core.bool hasGetGoroutineStackTraces() => $_has(39);
  @$pb.TagNumber(1041)
  void clearGetGoroutineStackTraces() => clearField(1041);
  @$pb.TagNumber(1041)
  GetGoroutineStackTracesRequest ensureGetGoroutineStackTraces() => $_ensure(39);

  @$pb.TagNumber(1078)
  $4.SignedData get sensitiveRequest => $_getN(40);
  @$pb.TagNumber(1078)
  set sensitiveRequest($4.SignedData v) { setField(1078, v); }
  @$pb.TagNumber(1078)
  $core.bool hasSensitiveRequest() => $_has(40);
  @$pb.TagNumber(1078)
  void clearSensitiveRequest() => clearField(1078);
  @$pb.TagNumber(1078)
  $4.SignedData ensureSensitiveRequest() => $_ensure(40);

  @$pb.TagNumber(2002)
  $11.DishStowRequest get dishStow => $_getN(41);
  @$pb.TagNumber(2002)
  set dishStow($11.DishStowRequest v) { setField(2002, v); }
  @$pb.TagNumber(2002)
  $core.bool hasDishStow() => $_has(41);
  @$pb.TagNumber(2002)
  void clearDishStow() => clearField(2002);
  @$pb.TagNumber(2002)
  $11.DishStowRequest ensureDishStow() => $_ensure(41);

  @$pb.TagNumber(2003)
  $11.DishGetContextRequest get dishGetContext => $_getN(42);
  @$pb.TagNumber(2003)
  set dishGetContext($11.DishGetContextRequest v) { setField(2003, v); }
  @$pb.TagNumber(2003)
  $core.bool hasDishGetContext() => $_has(42);
  @$pb.TagNumber(2003)
  void clearDishGetContext() => clearField(2003);
  @$pb.TagNumber(2003)
  $11.DishGetContextRequest ensureDishGetContext() => $_ensure(42);
  ...
  @$pb.TagNumber(2008)
  $11.DishGetObstructionMapRequest get dishGetObstructionMap => $_getN(44);
  @$pb.TagNumber(2008)
  set dishGetObstructionMap($11.DishGetObstructionMapRequest v) { setField(2008, v); }
  @$pb.TagNumber(2008)
  $core.bool hasDishGetObstructionMap() => $_has(44);
  @$pb.TagNumber(2008)
  void clearDishGetObstructionMap() => clearField(2008);
  @$pb.TagNumber(2008)
  $11.DishGetObstructionMapRequest ensureDishGetObstructionMap() => $_ensure(44);
  ...
  @$pb.TagNumber(2010)
  $11.DishSetConfigRequest get dishSetConfig => $_getN(46);
  @$pb.TagNumber(2010)
  set dishSetConfig($11.DishSetConfigRequest v) { setField(2010, v); }
  @$pb.TagNumber(2010)
  $core.bool hasDishSetConfig() => $_has(46);
  @$pb.TagNumber(2010)
  void clearDishSetConfig() => clearField(2010);
  @$pb.TagNumber(2010)
  $11.DishSetConfigRequest ensureDishSetConfig() => $_ensure(46);

  @$pb.TagNumber(2011)
  $11.DishGetConfigRequest get dishGetConfig => $_getN(47);
  @$pb.TagNumber(2011)
  set dishGetConfig($11.DishGetConfigRequest v) { setField(2011, v); }
  @$pb.TagNumber(2011)
  $core.bool hasDishGetConfig() => $_has(47);
  @$pb.TagNumber(2011)
  void clearDishGetConfig() => clearField(2011);
  @$pb.TagNumber(2011)
  $11.DishGetConfigRequest ensureDishGetConfig() => $_ensure(47);
  ...
  @$pb.TagNumber(2014)
  $11.DishInhibitGpsRequest get dishInhibitGps => $_getN(49);
  @$pb.TagNumber(2014)
  set dishInhibitGps($11.DishInhibitGpsRequest v) { setField(2014, v); }
  @$pb.TagNumber(2014)
  $core.bool hasDishInhibitGps() => $_has(49);
  @$pb.TagNumber(2014)
  void clearDishInhibitGps() => clearField(2014);
  @$pb.TagNumber(2014)
  $11.DishInhibitGpsRequest ensureDishInhibitGps() => $_ensure(49);

  @$pb.TagNumber(2015)
  $11.DishGetDataRequest get dishGetData => $_getN(50);
  @$pb.TagNumber(2015)
  set dishGetData($11.DishGetDataRequest v) { setField(2015, v); }
  @$pb.TagNumber(2015)
  $core.bool hasDishGetData() => $_has(50);
  @$pb.TagNumber(2015)
  void clearDishGetData() => clearField(2015);
  @$pb.TagNumber(2015)
  $11.DishGetDataRequest ensureDishGetData() => $_ensure(50);

  @$pb.TagNumber(2017)
  $11.DishClearObstructionMapRequest get dishClearObstructionMap => $_getN(51);
  @$pb.TagNumber(2017)
  set dishClearObstructionMap($11.DishClearObstructionMapRequest v) { setField(2017, v); }
  @$pb.TagNumber(2017)
  $core.bool hasDishClearObstructionMap() => $_has(51);
  @$pb.TagNumber(2017)
  void clearDishClearObstructionMap() => clearField(2017);
  @$pb.TagNumber(2017)
  $11.DishClearObstructionMapRequest ensureDishClearObstructionMap() => $_ensure(51);
  ...
  @$pb.TagNumber(2019)
  $11.DishActivateRssiScanRequest get dishActivateRssiScan => $_getN(53);
  @$pb.TagNumber(2019)
  set dishActivateRssiScan($11.DishActivateRssiScanRequest v) { setField(2019, v); }
  @$pb.TagNumber(2019)
  $core.bool hasDishActivateRssiScan() => $_has(53);
  @$pb.TagNumber(2019)
  void clearDishActivateRssiScan() => clearField(2019);
  @$pb.TagNumber(2019)
  $11.DishActivateRssiScanRequest ensureDishActivateRssiScan() => $_ensure(53);

  @$pb.TagNumber(2020)
  $11.DishGetRssiScanResultRequest get dishGetRssiScanResult => $_getN(54);
  @$pb.TagNumber(2020)
  set dishGetRssiScanResult($11.DishGetRssiScanResultRequest v) { setField(2020, v); }
  @$pb.TagNumber(2020)
  $core.bool hasDishGetRssiScanResult() => $_has(54);
  @$pb.TagNumber(2020)
  void clearDishGetRssiScanResult() => clearField(2020);
  @$pb.TagNumber(2020)
  $11.DishGetRssiScanResultRequest ensureDishGetRssiScanResult() => $_ensure(54);

  @$pb.TagNumber(2021)
  $11.DishFactoryResetRequest get dishFactoryReset => $_getN(55);
  @$pb.TagNumber(2021)
  set dishFactoryReset($11.DishFactoryResetRequest v) { setField(2021, v); }
  @$pb.TagNumber(2021)
  $core.bool hasDishFactoryReset() => $_has(55);
  @$pb.TagNumber(2021)
  void clearDishFactoryReset() => clearField(2021);
  @$pb.TagNumber(2021)
  $11.DishFactoryResetRequest ensureDishFactoryReset() => $_ensure(55);

  @$pb.TagNumber(2022)
  $11.ResetButtonRequest get resetButton => $_getN(56);
  @$pb.TagNumber(2022)
  set resetButton($11.ResetButtonRequest v) { setField(2022, v); }
  @$pb.TagNumber(2022)
  $core.bool hasResetButton() => $_has(56);
  @$pb.TagNumber(2022)
  void clearResetButton() => clearField(2022);
  @$pb.TagNumber(2022)
  $11.ResetButtonRequest ensureResetButton() => $_ensure(56);

  @$pb.TagNumber(2023)
  $4.SoftwareUpdateRequest get setPerVehicleConfig => $_getN(57);
  @$pb.TagNumber(2023)
  set setPerVehicleConfig($4.SoftwareUpdateRequest v) { setField(2023, v); }
  @$pb.TagNumber(2023)
  $core.bool hasSetPerVehicleConfig() => $_has(57);
  @$pb.TagNumber(2023)
  void clearSetPerVehicleConfig() => clearField(2023);
  @$pb.TagNumber(2023)
  $4.SoftwareUpdateRequest ensureSetPerVehicleConfig() => $_ensure(57);

  @$pb.TagNumber(2024)
  $11.DishAviationTestRequest get dishAviationTest => $_getN(58);
  @$pb.TagNumber(2024)
  set dishAviationTest($11.DishAviationTestRequest v) { setField(2024, v); }
  @$pb.TagNumber(2024)
  $core.bool hasDishAviationTest() => $_has(58);
  @$pb.TagNumber(2024)
  void clearDishAviationTest() => clearField(2024);
  @$pb.TagNumber(2024)
  $11.DishAviationTestRequest ensureDishAviationTest() => $_ensure(58);

  @$pb.TagNumber(2026)
  $11.DishInhibitRfRequest get dishInhibitRf => $_getN(59);
  @$pb.TagNumber(2026)
  set dishInhibitRf($11.DishInhibitRfRequest v) { setField(2026, v); }
  @$pb.TagNumber(2026)
  $core.bool hasDishInhibitRf() => $_has(59);
  @$pb.TagNumber(2026)
  void clearDishInhibitRf() => clearField(2026);
  @$pb.TagNumber(2026)
  $11.DishInhibitRfRequest ensureDishInhibitRf() => $_ensure(59);

  @$pb.TagNumber(3001)
  $0.WifiSetConfigRequest get wifiSetConfig => $_getN(60);
  @$pb.TagNumber(3001)
  ...
  @$pb.TagNumber(3001)
  $0.WifiSetConfigRequest ensureWifiSetConfig() => $_ensure(60);

  @$pb.TagNumber(3002)
  $0.WifiGetClientsRequest get wifiGetClients => $_getN(61);
  @$pb.TagNumber(3002)
  ...
  @$pb.TagNumber(3002)
  $0.WifiGetClientsRequest ensureWifiGetClients() => $_ensure(61);

  @$pb.TagNumber(3003)
  $0.WifiSetupRequest get wifiSetup => $_getN(62);
  @$pb.TagNumber(3003)
  ...
  @$pb.TagNumber(3003)
  $0.WifiSetupRequest ensureWifiSetup() => $_ensure(62);

  @$pb.TagNumber(3007)
  $0.WifiGetPingMetricsRequest get wifiGetPingMetrics => $_getN(63);
  @$pb.TagNumber(3007)
  ...
  @$pb.TagNumber(3007)
  $0.WifiGetPingMetricsRequest ensureWifiGetPingMetrics() => $_ensure(63);

  @$pb.TagNumber(3009)
  $0.WifiGetConfigRequest get wifiGetConfig => $_getN(64);
  @$pb.TagNumber(3009)
  ...
  @$pb.TagNumber(3009)
  $0.WifiGetConfigRequest ensureWifiGetConfig() => $_ensure(64);

  @$pb.TagNumber(3012)
  $0.WifiSetMeshDeviceTrustRequest get wifiSetMeshDeviceTrust => $_getN(65);
  @$pb.TagNumber(3012)
  ...
  @$pb.TagNumber(3012)
  $0.WifiSetMeshDeviceTrustRequest ensureWifiSetMeshDeviceTrust() => $_ensure(65);

  @$pb.TagNumber(3013)
  $0.WifiSetMeshConfigRequest get wifiSetMeshConfig => $_getN(66);
  @$pb.TagNumber(3013)
  ...
  @$pb.TagNumber(3013)
  $0.WifiSetMeshConfigRequest ensureWifiSetMeshConfig() => $_ensure(66);

  @$pb.TagNumber(3015)
  $0.WifiGetClientHistoryRequest get wifiGetClientHistory => $_getN(67);
  @$pb.TagNumber(3015)
  ...
  @$pb.TagNumber(3015)
  $0.WifiGetClientHistoryRequest ensureWifiGetClientHistory() => $_ensure(67);

  @$pb.TagNumber(3016)
  $0.WifiSetAviationConformedRequest get wifiSetAviationConformed => $_getN(68);
  @$pb.TagNumber(3016)
  ...
  @$pb.TagNumber(3016)
  $0.WifiSetAviationConformedRequest ensureWifiSetAviationConformed() => $_ensure(68);

  @$pb.TagNumber(3017)
  $0.WifiSetClientGivenNameRequest get wifiSetClientGivenName => $_getN(69);
  @$pb.TagNumber(3017)
  ...
  @$pb.TagNumber(3017)
  $0.WifiSetClientGivenNameRequest ensureWifiSetClientGivenName() => $_ensure(69);

  @$pb.TagNumber(3018)
  $0.WifiSelfTestRequest get wifiSelfTest => $_getN(70);
  @$pb.TagNumber(3018)
  ...
  @$pb.TagNumber(3018)
  $0.WifiSelfTestRequest ensureWifiSelfTest() => $_ensure(70);

  @$pb.TagNumber(3019)
  $0.WifiCalibrationModeRequest get wifiCalibrationMode => $_getN(71);
  @$pb.TagNumber(3019)
  ...
  @$pb.TagNumber(3019)
  $0.WifiCalibrationModeRequest ensureWifiCalibrationMode() => $_ensure(71);

  @$pb.TagNumber(3020)
  $0.WifiGuestInfoRequest get wifiGuestInfo => $_getN(72);
  @$pb.TagNumber(3020)
  ...
  @$pb.TagNumber(3020)
  $0.WifiGuestInfoRequest ensureWifiGuestInfo() => $_ensure(72);

  @$pb.TagNumber(3021)
  $0.WifiRfTestRequest get wifiRfTest => $_getN(73);
  @$pb.TagNumber(3021)
  ...
  @$pb.TagNumber(3021)
  $0.WifiRfTestRequest ensureWifiRfTest() => $_ensure(73);

  @$pb.TagNumber(3024)
  $0.WifiGetFirewallRequest get wifiGetFirewall => $_getN(74);
  @$pb.TagNumber(3024)
  ...
  @$pb.TagNumber(3024)
  $0.WifiGetFirewallRequest ensureWifiGetFirewall() => $_ensure(74);

  @$pb.TagNumber(3025)
  $0.WifiTogglePoeNegotiationRequest get wifiTogglePoeNegotiation => $_getN(75);
  @$pb.TagNumber(3025)
  ...
  @$pb.TagNumber(3025)
  $0.WifiTogglePoeNegotiationRequest ensureWifiTogglePoeNegotiation() => $_ensure(75);

  @$pb.TagNumber(3026)
  $0.WifiFactoryTestCommandRequest get wifiFactoryTestCommand => $_getN(76);
  @$pb.TagNumber(3026)
  ...
  @$pb.TagNumber(3026)
  $0.WifiFactoryTestCommandRequest ensureWifiFactoryTestCommand() => $_ensure(76);

  @$pb.TagNumber(3027)
  $0.WifiStartLocalTelemProxyRequest get wifiStartLocalTelemProxy => $_getN(77);
  @$pb.TagNumber(3027)
  ...
  @$pb.TagNumber(3027)
  $0.WifiStartLocalTelemProxyRequest ensureWifiStartLocalTelemProxy() => $_ensure(77);

  @$pb.TagNumber(3028)
  $0.WifiRunSelfTestRequest get wifiRunSelfTest => $_getN(78);
  @$pb.TagNumber(3028)
  ...
  @$pb.TagNumber(3028)
  $0.WifiRunSelfTestRequest ensureWifiRunSelfTest() => $_ensure(78);

  @$pb.TagNumber(3029)
  $0.WifiBackhaulStatsRequest get wifiBackhaulStats => $_getN(79);
  @$pb.TagNumber(3029)
  ...
  @$pb.TagNumber(3029)
  $0.WifiBackhaulStatsRequest ensureWifiBackhaulStats() => $_ensure(79);

  @$pb.TagNumber(3030)
  $0.WifiToggleUmbilicalModeRequest get wifiToggleUmbilicalMode => $_getN(80);
  @$pb.TagNumber(3030)
  ...
  @$pb.TagNumber(3030)
  $0.WifiToggleUmbilicalModeRequest ensureWifiToggleUmbilicalMode() => $_ensure(80);
  ...
  @$pb.TagNumber(3032)
  $0.WifiRunDebugNetsysRequest get wifiRunDebugNetsys => $_getN(82);
  @$pb.TagNumber(3032)
  set wifiRunDebugNetsys($0.WifiRunDebugNetsysRequest v) { setField(3032, v); }
  @$pb.TagNumber(3032)
  $core.bool hasWifiRunDebugNetsys() => $_has(82);
  @$pb.TagNumber(3032)
  void clearWifiRunDebugNetsys() => clearField(3032);
  @$pb.TagNumber(3032)
  $0.WifiRunDebugNetsysRequest ensureWifiRunDebugNetsys() => $_ensure(82);

  @$pb.TagNumber(3033)
  $0.WifiResetEthPhyRequest get wifiResetEthPhy => $_getN(83);
  @$pb.TagNumber(3033)
  set wifiResetEthPhy($0.WifiResetEthPhyRequest v) { setField(3033, v); }
  @$pb.TagNumber(3033)
  $core.bool hasWifiResetEthPhy() => $_has(83);
  @$pb.TagNumber(3033)
  void clearWifiResetEthPhy() => clearField(3033);
  @$pb.TagNumber(3033)
  $0.WifiResetEthPhyRequest ensureWifiResetEthPhy() => $_ensure(83);

  @$pb.TagNumber(3034)
  $0.WifiFlushHardwareNatRequest get wifiFlushHardwareNat => $_getN(84);
  @$pb.TagNumber(3034)
  set wifiFlushHardwareNat($0.WifiFlushHardwareNatRequest v) { setField(3034, v); }
  @$pb.TagNumber(3034)
  $core.bool hasWifiFlushHardwareNat() => $_has(84);
  @$pb.TagNumber(3034)
  void clearWifiFlushHardwareNat() => clearField(3034);
  @$pb.TagNumber(3034)
  $0.WifiFlushHardwareNatRequest ensureWifiFlushHardwareNat() => $_ensure(84);

  @$pb.TagNumber(3035)
  WifiWriteCalibrationRequest get wifiWriteCalibration => $_getN(85);
  @$pb.TagNumber(3035)
  set wifiWriteCalibration(WifiWriteCalibrationRequest v) { setField(3035, v); }
  @$pb.TagNumber(3035)
  $core.bool hasWifiWriteCalibration() => $_has(85);
  @$pb.TagNumber(3035)
  void clearWifiWriteCalibration() => clearField(3035);
  @$pb.TagNumber(3035)
  WifiWriteCalibrationRequest ensureWifiWriteCalibration() => $_ensure(85);

  @$pb.TagNumber(4001)
  $16.TransceiverIFLoopbackTestRequest get transceiverIfLoopbackTest => $_getN(86);
  @$pb.TagNumber(4001)
  set transceiverIfLoopbackTest($16.TransceiverIFLoopbackTestRequest v) { setField(4001, v); }
  @$pb.TagNumber(4001)
  $core.bool hasTransceiverIfLoopbackTest() => $_has(86);
  @$pb.TagNumber(4001)
  void clearTransceiverIfLoopbackTest() => clearField(4001);
  @$pb.TagNumber(4001)
  $16.TransceiverIFLoopbackTestRequest ensureTransceiverIfLoopbackTest() => $_ensure(86);

  @$pb.TagNumber(4003)
  $16.TransceiverGetStatusRequest get transceiverGetStatus => $_getN(87);
  @$pb.TagNumber(4003)
  set transceiverGetStatus($16.TransceiverGetStatusRequest v) { setField(4003, v); }
  @$pb.TagNumber(4003)
  $core.bool hasTransceiverGetStatus() => $_has(87);
  @$pb.TagNumber(4003)
  void clearTransceiverGetStatus() => clearField(4003);
  @$pb.TagNumber(4003)
  $16.TransceiverGetStatusRequest ensureTransceiverGetStatus() => $_ensure(87);

  @$pb.TagNumber(4004)
  $16.TransceiverGetTelemetryRequest get transceiverGetTelemetry => $_getN(88);
  @$pb.TagNumber(4004)
  set transceiverGetTelemetry($16.TransceiverGetTelemetryRequest v) { setField(4004, v); }
  @$pb.TagNumber(4004)
  $core.bool hasTransceiverGetTelemetry() => $_has(88);
  @$pb.TagNumber(4004)
  void clearTransceiverGetTelemetry() => clearField(4004);
  @$pb.TagNumber(4004)
  $16.TransceiverGetTelemetryRequest ensureTransceiverGetTelemetry() => $_ensure(88);

  @$pb.TagNumber(5000)
  $1.StartUnlockRequest get startUnlock => $_getN(89);
  @$pb.TagNumber(5000)
  ...
  @$pb.TagNumber(5000)
  $1.StartUnlockRequest ensureStartUnlock() => $_ensure(89);

  @$pb.TagNumber(5001)
  $1.FinishUnlockRequest get finishUnlock => $_getN(90);
  @$pb.TagNumber(5001)
  ...
  @$pb.TagNumber(5001)
  $1.FinishUnlockRequest ensureFinishUnlock() => $_ensure(90);
...
class Response extends $pb.GeneratedMessage {
  factory Response({
    ...
    $4.InitiateRemoteSshResponse? initiateRemoteSsh,
    $11.SelfTestResponse? selfTest,
    $11.SetTestModeResponse? setTestMode,
    $4.SoftwareUpdateResponse? softwareUpdate,
    ...
    $11.DishStowResponse? dishStow,
    $11.DishGetContextResponse? dishGetContext,
    $11.DishGetStatusResponse? dishGetStatus,
    $11.DishAuthenticateResponse? dishAuthenticate,
    $11.DishGetHistoryResponse? dishGetHistory,
    DishSetEmcResponse? dishSetEmc,
    $11.DishGetObstructionMapResponse? dishGetObstructionMap,
    DishGetEmcResponse? dishGetEmc,
    $11.DishSetConfigResponse? dishSetConfig,
    $11.DishGetConfigResponse? dishGetConfig,
    $11.DishInhibitGpsResponse? dishInhibitGps,
    $11.DishClearObstructionMapResponse? dishClearObstructionMap,
    DishSetMaxPowerTestModeResponse? dishSetMaxPowerTestMode,
    $11.DishActivateRssiScanResponse? dishActivateRssiScan,
    $11.DishGetRssiScanResultResponse? dishGetRssiScanResult,
    $11.DishFactoryResetResponse? dishFactoryReset,
    $11.ResetButtonResponse? resetButton,
    SetPerVehicleConfigResponse? setPerVehicleConfig,
    $11.DishAviationTestResponse? dishAviationTest,
    $11.DishInhibitRfResponse? dishInhibitRf,
    ...
    $0.WifiUpdateResponse? wifiUpdate,
    $0.WifiRunDebugNetsysResponse? wifiRunDebugNetsys,
    $0.WifiResetEthPhyResponse? wifiResetEthPhy,
    $0.WifiFlushHardwareNatResponse? wifiFlushHardwareNat,
    $16.TransceiverIFLoopbackTestResponse? transceiverIfLoopbackTest,
    $16.TransceiverGetStatusResponse? transceiverGetStatus,
    $16.TransceiverGetTelemetryResponse? transceiverGetTelemetry,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Response', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..oo(0, [1001, 1003, 1004, 1006, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1019, 1020, 1021, 1023, 1027, 1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1037, 1038, 1041, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2013, 2015, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2026, 3001, 3002, 3003, 3004, 3005, 3006, 3007, 3009, 3012, 3013, 3015, 3016, 3020, 3021, 3022, 3024, 3025, 3026, 3027, 3028, 3029, 3030, 3031, 4001, 4003, 4004, 5000, 5001, 6000, 6001])
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$17.Status>(2, _omitFieldNames ? '' : 'status', subBuilder: $17.Status.create)
    ...
    ..aOM<$4.GetNextIdResponse>(1006, _omitFieldNames ? '' : 'getNextId', subBuilder: $4.GetNextIdResponse.create)
    ...
    ..aOM<$4.InitiateRemoteSshResponse>(1030, _omitFieldNames ? '' : 'initiateRemoteSsh', subBuilder: $4.InitiateRemoteSshResponse.create)
    ..aOM<$11.SelfTestResponse>(1031, _omitFieldNames ? '' : 'selfTest', subBuilder: $11.SelfTestResponse.create)
    ..aOM<$11.SetTestModeResponse>(1032, _omitFieldNames ? '' : 'setTestMode', subBuilder: $11.SetTestModeResponse.create)
    ..aOM<$4.SoftwareUpdateResponse>(1033, _omitFieldNames ? '' : 'softwareUpdate', subBuilder: $4.SoftwareUpdateResponse.create)
    ...
    ..aOM<GetGoroutineStackTracesResponse>(1041, _omitFieldNames ? '' : 'getGoroutineStackTraces', subBuilder: GetGoroutineStackTracesResponse.create)
    ..aOM<$11.DishStowResponse>(2002, _omitFieldNames ? '' : 'dishStow', subBuilder: $11.DishStowResponse.create)
    ..aOM<$11.DishGetContextResponse>(2003, _omitFieldNames ? '' : 'dishGetContext', subBuilder: $11.DishGetContextResponse.create)
    ..aOM<$11.DishGetStatusResponse>(2004, _omitFieldNames ? '' : 'dishGetStatus', subBuilder: $11.DishGetStatusResponse.create)
    ..aOM<$11.DishAuthenticateResponse>(2005, _omitFieldNames ? '' : 'dishAuthenticate', subBuilder: $11.DishAuthenticateResponse.create)
    ..aOM<$11.DishGetHistoryResponse>(2006, _omitFieldNames ? '' : 'dishGetHistory', subBuilder: $11.DishGetHistoryResponse.create)
    ..aOM<DishSetEmcResponse>(2007, _omitFieldNames ? '' : 'dishSetEmc', subBuilder: DishSetEmcResponse.create)
    ..aOM<$11.DishGetObstructionMapResponse>(2008, _omitFieldNames ? '' : 'dishGetObstructionMap', subBuilder: $11.DishGetObstructionMapResponse.create)
    ..aOM<DishGetEmcResponse>(2009, _omitFieldNames ? '' : 'dishGetEmc', subBuilder: DishGetEmcResponse.create)
    ..aOM<$11.DishSetConfigResponse>(2010, _omitFieldNames ? '' : 'dishSetConfig', subBuilder: $11.DishSetConfigResponse.create)
    ..aOM<$11.DishGetConfigResponse>(2011, _omitFieldNames ? '' : 'dishGetConfig', subBuilder: $11.DishGetConfigResponse.create)
    ..aOM<$11.DishInhibitGpsResponse>(2013, _omitFieldNames ? '' : 'dishInhibitGps', subBuilder: $11.DishInhibitGpsResponse.create)
    ..aOM<$11.DishClearObstructionMapResponse>(2015, _omitFieldNames ? '' : 'dishClearObstructionMap', subBuilder: $11.DishClearObstructionMapResponse.create)
    ...
    ..aOM<$11.DishActivateRssiScanResponse>(2019, _omitFieldNames ? '' : 'dishActivateRssiScan', subBuilder: $11.DishActivateRssiScanResponse.create)
    ..aOM<$11.DishGetRssiScanResultResponse>(2020, _omitFieldNames ? '' : 'dishGetRssiScanResult', subBuilder: $11.DishGetRssiScanResultResponse.create)
    ..aOM<$11.DishFactoryResetResponse>(2021, _omitFieldNames ? '' : 'dishFactoryReset', subBuilder: $11.DishFactoryResetResponse.create)
    ..aOM<$11.ResetButtonResponse>(2022, _omitFieldNames ? '' : 'resetButton', subBuilder: $11.ResetButtonResponse.create)
    ..aOM<SetPerVehicleConfigResponse>(2023, _omitFieldNames ? '' : 'setPerVehicleConfig', subBuilder: SetPerVehicleConfigResponse.create)
    ..aOM<$11.DishAviationTestResponse>(2024, _omitFieldNames ? '' : 'dishAviationTest', subBuilder: $11.DishAviationTestResponse.create)
    ..aOM<$11.DishInhibitRfResponse>(2026, _omitFieldNames ? '' : 'dishInhibitRf', subBuilder: $11.DishInhibitRfResponse.create)
    ...
    ..aOM<$0.WifiUpdateResponse>(3028, _omitFieldNames ? '' : 'wifiUpdate', subBuilder: $0.WifiUpdateResponse.create)
    ..aOM<$0.WifiRunDebugNetsysResponse>(3029, _omitFieldNames ? '' : 'wifiRunDebugNetsys', subBuilder: $0.WifiRunDebugNetsysResponse.create)
    ..aOM<$0.WifiResetEthPhyResponse>(3030, _omitFieldNames ? '' : 'wifiResetEthPhy', subBuilder: $0.WifiResetEthPhyResponse.create)
    ..aOM<$0.WifiFlushHardwareNatResponse>(3031, _omitFieldNames ? '' : 'wifiFlushHardwareNat', subBuilder: $0.WifiFlushHardwareNatResponse.create)
    ..aOM<$16.TransceiverIFLoopbackTestResponse>(4001, _omitFieldNames ? '' : 'transceiverIfLoopbackTest', subBuilder: $16.TransceiverIFLoopbackTestResponse.create)
    ..aOM<$16.TransceiverGetStatusResponse>(4003, _omitFieldNames ? '' : 'transceiverGetStatus', subBuilder: $16.TransceiverGetStatusResponse.create)
    ..aOM<$16.TransceiverGetTelemetryResponse>(4004, _omitFieldNames ? '' : 'transceiverGetTelemetry', subBuilder: $16.TransceiverGetTelemetryResponse.create)
  ...
  @$pb.TagNumber(2)
  $17.Status get status => $_getN(1);
  @$pb.TagNumber(2)
  set status($17.Status v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStatus() => $_has(1);
  @$pb.TagNumber(2)
  void clearStatus() => clearField(2);
  @$pb.TagNumber(2)
  $17.Status ensureStatus() => $_ensure(1);
  ...
  @$pb.TagNumber(1006)
  $4.GetNextIdResponse get getNextId => $_getN(6);
  @$pb.TagNumber(1006)
  set getNextId($4.GetNextIdResponse v) { setField(1006, v); }
  @$pb.TagNumber(1006)
  $core.bool hasGetNextId() => $_has(6);
  @$pb.TagNumber(1006)
  void clearGetNextId() => clearField(1006);
  @$pb.TagNumber(1006)
  $4.GetNextIdResponse ensureGetNextId() => $_ensure(6);
  ...
  @$pb.TagNumber(1030)
  $4.InitiateRemoteSshResponse get initiateRemoteSsh => $_getN(23);
  @$pb.TagNumber(1030)
  set initiateRemoteSsh($4.InitiateRemoteSshResponse v) { setField(1030, v); }
  @$pb.TagNumber(1030)
  $core.bool hasInitiateRemoteSsh() => $_has(23);
  @$pb.TagNumber(1030)
  void clearInitiateRemoteSsh() => clearField(1030);
  @$pb.TagNumber(1030)
  $4.InitiateRemoteSshResponse ensureInitiateRemoteSsh() => $_ensure(23);

  @$pb.TagNumber(1031)
  $11.SelfTestResponse get selfTest => $_getN(24);
  @$pb.TagNumber(1031)
  set selfTest($11.SelfTestResponse v) { setField(1031, v); }
  @$pb.TagNumber(1031)
  $core.bool hasSelfTest() => $_has(24);
  @$pb.TagNumber(1031)
  void clearSelfTest() => clearField(1031);
  @$pb.TagNumber(1031)
  $11.SelfTestResponse ensureSelfTest() => $_ensure(24);

  @$pb.TagNumber(1032)
  $11.SetTestModeResponse get setTestMode => $_getN(25);
  @$pb.TagNumber(1032)
  set setTestMode($11.SetTestModeResponse v) { setField(1032, v); }
  @$pb.TagNumber(1032)
  $core.bool hasSetTestMode() => $_has(25);
  @$pb.TagNumber(1032)
  void clearSetTestMode() => clearField(1032);
  @$pb.TagNumber(1032)
  $11.SetTestModeResponse ensureSetTestMode() => $_ensure(25);

  @$pb.TagNumber(1033)
  $4.SoftwareUpdateResponse get softwareUpdate => $_getN(26);
  @$pb.TagNumber(1033)
  set softwareUpdate($4.SoftwareUpdateResponse v) { setField(1033, v); }
  @$pb.TagNumber(1033)
  $core.bool hasSoftwareUpdate() => $_has(26);
  @$pb.TagNumber(1033)
  void clearSoftwareUpdate() => clearField(1033);
  @$pb.TagNumber(1033)
  $4.SoftwareUpdateResponse ensureSoftwareUpdate() => $_ensure(26);
  ...
  @$pb.TagNumber(1041)
  set getGoroutineStackTraces(GetGoroutineStackTracesResponse v) { setField(1041, v); }
  @$pb.TagNumber(1041)
  $core.bool hasGetGoroutineStackTraces() => $_has(31);
  @$pb.TagNumber(1041)
  void clearGetGoroutineStackTraces() => clearField(1041);
  @$pb.TagNumber(1041)
  GetGoroutineStackTracesResponse ensureGetGoroutineStackTraces() => $_ensure(31);

  @$pb.TagNumber(2002)
  $11.DishStowResponse get dishStow => $_getN(32);
  @$pb.TagNumber(2002)
  set dishStow($11.DishStowResponse v) { setField(2002, v); }
  @$pb.TagNumber(2002)
  $core.bool hasDishStow() => $_has(32);
  @$pb.TagNumber(2002)
  void clearDishStow() => clearField(2002);
  @$pb.TagNumber(2002)
  $11.DishStowResponse ensureDishStow() => $_ensure(32);

  @$pb.TagNumber(2003)
  $11.DishGetContextResponse get dishGetContext => $_getN(33);
  @$pb.TagNumber(2003)
  set dishGetContext($11.DishGetContextResponse v) { setField(2003, v); }
  @$pb.TagNumber(2003)
  $core.bool hasDishGetContext() => $_has(33);
  @$pb.TagNumber(2003)
  void clearDishGetContext() => clearField(2003);
  @$pb.TagNumber(2003)
  $11.DishGetContextResponse ensureDishGetContext() => $_ensure(33);

  @$pb.TagNumber(2004)
  $11.DishGetStatusResponse get dishGetStatus => $_getN(34);
  @$pb.TagNumber(2004)
  set dishGetStatus($11.DishGetStatusResponse v) { setField(2004, v); }
  @$pb.TagNumber(2004)
  $core.bool hasDishGetStatus() => $_has(34);
  @$pb.TagNumber(2004)
  void clearDishGetStatus() => clearField(2004);
  @$pb.TagNumber(2004)
  $11.DishGetStatusResponse ensureDishGetStatus() => $_ensure(34);

  @$pb.TagNumber(2005)
  $11.DishAuthenticateResponse get dishAuthenticate => $_getN(35);
  @$pb.TagNumber(2005)
  set dishAuthenticate($11.DishAuthenticateResponse v) { setField(2005, v); }
  @$pb.TagNumber(2005)
  $core.bool hasDishAuthenticate() => $_has(35);
  @$pb.TagNumber(2005)
  void clearDishAuthenticate() => clearField(2005);
  @$pb.TagNumber(2005)
  $11.DishAuthenticateResponse ensureDishAuthenticate() => $_ensure(35);

  @$pb.TagNumber(2006)
  $11.DishGetHistoryResponse get dishGetHistory => $_getN(36);
  @$pb.TagNumber(2006)
  set dishGetHistory($11.DishGetHistoryResponse v) { setField(2006, v); }
  @$pb.TagNumber(2006)
  $core.bool hasDishGetHistory() => $_has(36);
  @$pb.TagNumber(2006)
  void clearDishGetHistory() => clearField(2006);
  @$pb.TagNumber(2006)
  $11.DishGetHistoryResponse ensureDishGetHistory() => $_ensure(36);
  ...
  @$pb.TagNumber(2008)
  $11.DishGetObstructionMapResponse get dishGetObstructionMap => $_getN(38);
  @$pb.TagNumber(2008)
  set dishGetObstructionMap($11.DishGetObstructionMapResponse v) { setField(2008, v); }
  @$pb.TagNumber(2008)
  $core.bool hasDishGetObstructionMap() => $_has(38);
  @$pb.TagNumber(2008)
  void clearDishGetObstructionMap() => clearField(2008);
  @$pb.TagNumber(2008)
  $11.DishGetObstructionMapResponse ensureDishGetObstructionMap() => $_ensure(38);
  ...
  @$pb.TagNumber(2010)
  $11.DishSetConfigResponse get dishSetConfig => $_getN(40);
  @$pb.TagNumber(2010)
  set dishSetConfig($11.DishSetConfigResponse v) { setField(2010, v); }
  @$pb.TagNumber(2010)
  $core.bool hasDishSetConfig() => $_has(40);
  @$pb.TagNumber(2010)
  void clearDishSetConfig() => clearField(2010);
  @$pb.TagNumber(2010)
  $11.DishSetConfigResponse ensureDishSetConfig() => $_ensure(40);

  @$pb.TagNumber(2011)
  $11.DishGetConfigResponse get dishGetConfig => $_getN(41);
  @$pb.TagNumber(2011)
  set dishGetConfig($11.DishGetConfigResponse v) { setField(2011, v); }
  @$pb.TagNumber(2011)
  $core.bool hasDishGetConfig() => $_has(41);
  @$pb.TagNumber(2011)
  void clearDishGetConfig() => clearField(2011);
  @$pb.TagNumber(2011)
  $11.DishGetConfigResponse ensureDishGetConfig() => $_ensure(41);

  @$pb.TagNumber(2013)
  $11.DishInhibitGpsResponse get dishInhibitGps => $_getN(42);
  @$pb.TagNumber(2013)
  set dishInhibitGps($11.DishInhibitGpsResponse v) { setField(2013, v); }
  @$pb.TagNumber(2013)
  $core.bool hasDishInhibitGps() => $_has(42);
  @$pb.TagNumber(2013)
  void clearDishInhibitGps() => clearField(2013);
  @$pb.TagNumber(2013)
  $11.DishInhibitGpsResponse ensureDishInhibitGps() => $_ensure(42);

  @$pb.TagNumber(2015)
  $11.DishClearObstructionMapResponse get dishClearObstructionMap => $_getN(43);
  @$pb.TagNumber(2015)
  set dishClearObstructionMap($11.DishClearObstructionMapResponse v) { setField(2015, v); }
  @$pb.TagNumber(2015)
  $core.bool hasDishClearObstructionMap() => $_has(43);
  @$pb.TagNumber(2015)
  void clearDishClearObstructionMap() => clearField(2015);
  @$pb.TagNumber(2015)
  $11.DishClearObstructionMapResponse ensureDishClearObstructionMap() => $_ensure(43);
  ...
  @$pb.TagNumber(2019)
  $11.DishActivateRssiScanResponse get dishActivateRssiScan => $_getN(45);
  @$pb.TagNumber(2019)
  set dishActivateRssiScan($11.DishActivateRssiScanResponse v) { setField(2019, v); }
  @$pb.TagNumber(2019)
  $core.bool hasDishActivateRssiScan() => $_has(45);
  @$pb.TagNumber(2019)
  void clearDishActivateRssiScan() => clearField(2019);
  @$pb.TagNumber(2019)
  $11.DishActivateRssiScanResponse ensureDishActivateRssiScan() => $_ensure(45);

  @$pb.TagNumber(2020)
  $11.DishGetRssiScanResultResponse get dishGetRssiScanResult => $_getN(46);
  @$pb.TagNumber(2020)
  set dishGetRssiScanResult($11.DishGetRssiScanResultResponse v) { setField(2020, v); }
  @$pb.TagNumber(2020)
  $core.bool hasDishGetRssiScanResult() => $_has(46);
  @$pb.TagNumber(2020)
  void clearDishGetRssiScanResult() => clearField(2020);
  @$pb.TagNumber(2020)
  $11.DishGetRssiScanResultResponse ensureDishGetRssiScanResult() => $_ensure(46);

  @$pb.TagNumber(2021)
  $11.DishFactoryResetResponse get dishFactoryReset => $_getN(47);
  @$pb.TagNumber(2021)
  set dishFactoryReset($11.DishFactoryResetResponse v) { setField(2021, v); }
  @$pb.TagNumber(2021)
  $core.bool hasDishFactoryReset() => $_has(47);
  @$pb.TagNumber(2021)
  void clearDishFactoryReset() => clearField(2021);
  @$pb.TagNumber(2021)
  $11.DishFactoryResetResponse ensureDishFactoryReset() => $_ensure(47);

  @$pb.TagNumber(2022)
  $11.ResetButtonResponse get resetButton => $_getN(48);
  @$pb.TagNumber(2022)
  set resetButton($11.ResetButtonResponse v) { setField(2022, v); }
  @$pb.TagNumber(2022)
  $core.bool hasResetButton() => $_has(48);
  @$pb.TagNumber(2022)
  void clearResetButton() => clearField(2022);
  @$pb.TagNumber(2022)
  $11.ResetButtonResponse ensureResetButton() => $_ensure(48);

  @$pb.TagNumber(2023)
  SetPerVehicleConfigResponse get setPerVehicleConfig => $_getN(49);
  @$pb.TagNumber(2023)
  set setPerVehicleConfig(SetPerVehicleConfigResponse v) { setField(2023, v); }
  @$pb.TagNumber(2023)
  ...
  @$pb.TagNumber(2024)
  $11.DishAviationTestResponse get dishAviationTest => $_getN(50);
  @$pb.TagNumber(2024)
  set dishAviationTest($11.DishAviationTestResponse v) { setField(2024, v); }
  @$pb.TagNumber(2024)
  $core.bool hasDishAviationTest() => $_has(50);
  @$pb.TagNumber(2024)
  void clearDishAviationTest() => clearField(2024);
  @$pb.TagNumber(2024)
  $11.DishAviationTestResponse ensureDishAviationTest() => $_ensure(50);

  @$pb.TagNumber(2026)
  $11.DishInhibitRfResponse get dishInhibitRf => $_getN(51);
  @$pb.TagNumber(2026)
  set dishInhibitRf($11.DishInhibitRfResponse v) { setField(2026, v); }
  @$pb.TagNumber(2026)
  $core.bool hasDishInhibitRf() => $_has(51);
  @$pb.TagNumber(2026)
  void clearDishInhibitRf() => clearField(2026);
  @$pb.TagNumber(2026)
  $11.DishInhibitRfResponse ensureDishInhibitRf() => $_ensure(51);

  @$pb.TagNumber(3001)
  $0.WifiSetConfigResponse get wifiSetConfig => $_getN(52);
  @$pb.TagNumber(3001)
  ...
  void clearWifiSetConfig() => clearField(3001);
  @$pb.TagNumber(3001)
  $0.WifiSetConfigResponse ensureWifiSetConfig() => $_ensure(52);

  @$pb.TagNumber(3002)
  $0.WifiGetClientsResponse get wifiGetClients => $_getN(53);
  @$pb.TagNumber(3002)
  ...
  void clearWifiGetClients() => clearField(3002);
  @$pb.TagNumber(3002)
  $0.WifiGetClientsResponse ensureWifiGetClients() => $_ensure(53);

  @$pb.TagNumber(3003)
  $0.WifiSetupResponse get wifiSetup => $_getN(54);
  @$pb.TagNumber(3003)
  ...
  void clearWifiSetup() => clearField(3003);
  @$pb.TagNumber(3003)
  $0.WifiSetupResponse ensureWifiSetup() => $_ensure(54);

  @$pb.TagNumber(3004)
  $0.WifiGetStatusResponse get wifiGetStatus => $_getN(55);
  @$pb.TagNumber(3004)
  ...
  @$pb.TagNumber(3004)
  $0.WifiGetStatusResponse ensureWifiGetStatus() => $_ensure(55);

  @$pb.TagNumber(3005)
  $0.WifiAuthenticateResponse get wifiAuthenticate => $_getN(56);
  @$pb.TagNumber(3005)
  ...
  @$pb.TagNumber(3005)
  $0.WifiAuthenticateResponse ensureWifiAuthenticate() => $_ensure(56);

  @$pb.TagNumber(3006)
  $0.WifiGetHistoryResponse get wifiGetHistory => $_getN(57);
  @$pb.TagNumber(3006)
  ...
  @$pb.TagNumber(3006)
  $0.WifiGetHistoryResponse ensureWifiGetHistory() => $_ensure(57);

  @$pb.TagNumber(3007)
  $0.WifiGetPingMetricsResponse get wifiGetPingMetrics => $_getN(58);
  @$pb.TagNumber(3007)
  ...
  void clearWifiGetPingMetrics() => clearField(3007);
  @$pb.TagNumber(3007)
  $0.WifiGetPingMetricsResponse ensureWifiGetPingMetrics() => $_ensure(58);

  @$pb.TagNumber(3009)
  $0.WifiGetConfigResponse get wifiGetConfig => $_getN(59);
  @$pb.TagNumber(3009)
  ...
  void clearWifiGetConfig() => clearField(3009);
  @$pb.TagNumber(3009)
  $0.WifiGetConfigResponse ensureWifiGetConfig() => $_ensure(59);

  @$pb.TagNumber(3012)
  $0.WifiSetMeshDeviceTrustResponse get wifiSetMeshDeviceTrust => $_getN(60);
  @$pb.TagNumber(3012)
  ...
  void clearWifiSetMeshDeviceTrust() => clearField(3012);
  @$pb.TagNumber(3012)
  $0.WifiSetMeshDeviceTrustResponse ensureWifiSetMeshDeviceTrust() => $_ensure(60);

  @$pb.TagNumber(3013)
  $0.WifiSetMeshConfigResponse get wifiSetMeshConfig => $_getN(61);
  @$pb.TagNumber(3013)
  ...
  void clearWifiSetMeshConfig() => clearField(3013);
  @$pb.TagNumber(3013)
  $0.WifiSetMeshConfigResponse ensureWifiSetMeshConfig() => $_ensure(61);

  @$pb.TagNumber(3015)
  $0.WifiGetClientHistoryResponse get wifiGetClientHistory => $_getN(62);
  @$pb.TagNumber(3015)
  ...
  void clearWifiGetClientHistory() => clearField(3015);
  @$pb.TagNumber(3015)
  $0.WifiGetClientHistoryResponse ensureWifiGetClientHistory() => $_ensure(62);

  @$pb.TagNumber(3016)
  $0.WifiSelfTestResponse get wifiSelfTest => $_getN(63);
  @$pb.TagNumber(3016)
  ...
  @$pb.TagNumber(3016)
  $0.WifiSelfTestResponse ensureWifiSelfTest() => $_ensure(63);

  @$pb.TagNumber(3020)
  $0.WifiGuestInfoResponse get wifiGuestInfo => $_getN(64);
  @$pb.TagNumber(3020)
  ...
  void clearWifiGuestInfo() => clearField(3020);
  @$pb.TagNumber(3020)
  $0.WifiGuestInfoResponse ensureWifiGuestInfo() => $_ensure(64);

  @$pb.TagNumber(3021)
  $0.WifiRfTestResponse get wifiRfTest => $_getN(65);
  @$pb.TagNumber(3021)
  ...
  void clearWifiRfTest() => clearField(3021);
  @$pb.TagNumber(3021)
  $0.WifiRfTestResponse ensureWifiRfTest() => $_ensure(65);

  @$pb.TagNumber(3022)
  $0.WifiGetPersistentStatsResponse get wifiGetPersistentStats => $_getN(66);
  @$pb.TagNumber(3022)
  ...
  @$pb.TagNumber(3022)
  $0.WifiGetPersistentStatsResponse ensureWifiGetPersistentStats() => $_ensure(66);

  @$pb.TagNumber(3024)
  $0.WifiGetFirewallResponse get wifiGetFirewall => $_getN(67);
  @$pb.TagNumber(3024)
  ...
  void clearWifiGetFirewall() => clearField(3024);
  @$pb.TagNumber(3024)
  $0.WifiGetFirewallResponse ensureWifiGetFirewall() => $_ensure(67);

  @$pb.TagNumber(3025)
  $0.WifiFactoryTestCommandResponse get wifiFactoryTestCommand => $_getN(68);
  @$pb.TagNumber(3025)
  ...
  @$pb.TagNumber(3025)
  $0.WifiFactoryTestCommandResponse ensureWifiFactoryTestCommand() => $_ensure(68);

  @$pb.TagNumber(3026)
  $0.WifiBackhaulStatsResponse get wifiBackhaulStats => $_getN(69);
  @$pb.TagNumber(3026)
  ...
  @$pb.TagNumber(3026)
  $0.WifiBackhaulStatsResponse ensureWifiBackhaulStats() => $_ensure(69);
  ...
  @$pb.TagNumber(3028)
  $0.WifiUpdateResponse get wifiUpdate => $_getN(71);
  @$pb.TagNumber(3028)
  set wifiUpdate($0.WifiUpdateResponse v) { setField(3028, v); }
  @$pb.TagNumber(3028)
  $core.bool hasWifiUpdate() => $_has(71);
  @$pb.TagNumber(3028)
  void clearWifiUpdate() => clearField(3028);
  @$pb.TagNumber(3028)
  $0.WifiUpdateResponse ensureWifiUpdate() => $_ensure(71);

  @$pb.TagNumber(3029)
  $0.WifiRunDebugNetsysResponse get wifiRunDebugNetsys => $_getN(72);
  @$pb.TagNumber(3029)
  set wifiRunDebugNetsys($0.WifiRunDebugNetsysResponse v) { setField(3029, v); }
  @$pb.TagNumber(3029)
  $core.bool hasWifiRunDebugNetsys() => $_has(72);
  @$pb.TagNumber(3029)
  void clearWifiRunDebugNetsys() => clearField(3029);
  @$pb.TagNumber(3029)
  $0.WifiRunDebugNetsysResponse ensureWifiRunDebugNetsys() => $_ensure(72);

  @$pb.TagNumber(3030)
  $0.WifiResetEthPhyResponse get wifiResetEthPhy => $_getN(73);
  @$pb.TagNumber(3030)
  set wifiResetEthPhy($0.WifiResetEthPhyResponse v) { setField(3030, v); }
  @$pb.TagNumber(3030)
  $core.bool hasWifiResetEthPhy() => $_has(73);
  @$pb.TagNumber(3030)
  void clearWifiResetEthPhy() => clearField(3030);
  @$pb.TagNumber(3030)
  $0.WifiResetEthPhyResponse ensureWifiResetEthPhy() => $_ensure(73);

  @$pb.TagNumber(3031)
  $0.WifiFlushHardwareNatResponse get wifiFlushHardwareNat => $_getN(74);
  @$pb.TagNumber(3031)
  set wifiFlushHardwareNat($0.WifiFlushHardwareNatResponse v) { setField(3031, v); }
  @$pb.TagNumber(3031)
  $core.bool hasWifiFlushHardwareNat() => $_has(74);
  @$pb.TagNumber(3031)
  void clearWifiFlushHardwareNat() => clearField(3031);
  @$pb.TagNumber(3031)
  $0.WifiFlushHardwareNatResponse ensureWifiFlushHardwareNat() => $_ensure(74);

  @$pb.TagNumber(4001)
  $16.TransceiverIFLoopbackTestResponse get transceiverIfLoopbackTest => $_getN(75);
  @$pb.TagNumber(4001)
  set transceiverIfLoopbackTest($16.TransceiverIFLoopbackTestResponse v) { setField(4001, v); }
  @$pb.TagNumber(4001)
  $core.bool hasTransceiverIfLoopbackTest() => $_has(75);
  @$pb.TagNumber(4001)
  void clearTransceiverIfLoopbackTest() => clearField(4001);
  @$pb.TagNumber(4001)
  $16.TransceiverIFLoopbackTestResponse ensureTransceiverIfLoopbackTest() => $_ensure(75);

  @$pb.TagNumber(4003)
  $16.TransceiverGetStatusResponse get transceiverGetStatus => $_getN(76);
  @$pb.TagNumber(4003)
  set transceiverGetStatus($16.TransceiverGetStatusResponse v) { setField(4003, v); }
  @$pb.TagNumber(4003)
  $core.bool hasTransceiverGetStatus() => $_has(76);
  @$pb.TagNumber(4003)
  void clearTransceiverGetStatus() => clearField(4003);
  @$pb.TagNumber(4003)
  $16.TransceiverGetStatusResponse ensureTransceiverGetStatus() => $_ensure(76);

  @$pb.TagNumber(4004)
  $16.TransceiverGetTelemetryResponse get transceiverGetTelemetry => $_getN(77);
  @$pb.TagNumber(4004)
  set transceiverGetTelemetry($16.TransceiverGetTelemetryResponse v) { setField(4004, v); }
  @$pb.TagNumber(4004)
  $core.bool hasTransceiverGetTelemetry() => $_has(77);
  @$pb.TagNumber(4004)
  void clearTransceiverGetTelemetry() => clearField(4004);
  @$pb.TagNumber(4004)
  $16.TransceiverGetTelemetryResponse ensureTransceiverGetTelemetry() => $_ensure(77);

  @$pb.TagNumber(5000)
  $1.StartUnlockResponse get startUnlock => $_getN(78);
  @$pb.TagNumber(5000)
  ...
  void clearStartUnlock() => clearField(5000);
  @$pb.TagNumber(5000)
  $1.StartUnlockResponse ensureStartUnlock() => $_ensure(78);

  @$pb.TagNumber(5001)
  $1.FinishUnlockResponse get finishUnlock => $_getN(79);
  @$pb.TagNumber(5001)
  ...
  void clearFinishUnlock() => clearField(5001);
  @$pb.TagNumber(5001)
  $1.FinishUnlockResponse ensureFinishUnlock() => $_ensure(79);
...
class Event extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Event', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ...
    ..aOM<WifiClientSandboxRequest>(3005, _omitFieldNames ? '' : 'wifiClientSandbox', subBuilder: WifiClientSandboxRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3005)
  set wifiClientSandbox(WifiClientSandboxRequest v) { setField(3005, v); }
  @$pb.TagNumber(3005)
  $core.bool hasWifiClientSandbox() => $_has(4);
  @$pb.TagNumber(3005)
  void clearWifiClientSandbox() => clearField(3005);
  @$pb.TagNumber(3005)
...
class WifiClientSandboxRequest extends $pb.GeneratedMessage {
  ...
  WifiClientSandboxRequest._() : super();
  factory WifiClientSandboxRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WifiClientSandboxRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WifiClientSandboxRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..pc<WifiClientSandboxStatus>(1, _omitFieldNames ? '' : 'clientSandboxStatus', $pb.PbFieldType.PM, subBuilder: WifiClientSandboxStatus.create)
    ..pc<WifiClientSandboxAlert>(2, _omitFieldNames ? '' : 'alerts', $pb.PbFieldType.KE, valueOf: WifiClientSandboxAlert.valueOf, enumValues: WifiClientSandboxAlert.values, defaultEnumValue: WifiClientSandboxAlert.SANDBOX_ALERT_UNKNOWN)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'unixTimestampNs', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WifiClientSandboxRequest clone() => WifiClientSandboxRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WifiClientSandboxRequest copyWith(void Function(WifiClientSandboxRequest) updates) => super.copyWith((message) => updates(message as WifiClientSandboxRequest)) as WifiClientSandboxRequest;
  ...
  static $pb.PbList<WifiClientSandboxRequest> createRepeated() => $pb.PbList<WifiClientSandboxRequest>();
  @$core.pragma('dart2js:noInline')
  static WifiClientSandboxRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WifiClientSandboxRequest>(create);
  static WifiClientSandboxRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<WifiClientSandboxStatus> get clientSandboxStatus => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<WifiClientSandboxAlert> get alerts => $_getList(1);

  @$pb.TagNumber(3)
  $fixnum.Int64 get unixTimestampNs => $_getI64(2);
  @$pb.TagNumber(3)
  set unixTimestampNs($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasUnixTimestampNs() => $_has(2);
  @$pb.TagNumber(3)
  void clearUnixTimestampNs() => clearField(3);
}

class WifiClientSandboxResponse extends $pb.GeneratedMessage {
  factory WifiClientSandboxResponse() => create();
  WifiClientSandboxResponse._() : super();
  factory WifiClientSandboxResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WifiClientSandboxResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WifiClientSandboxResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WifiClientSandboxResponse clone() => WifiClientSandboxResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WifiClientSandboxResponse copyWith(void Function(WifiClientSandboxResponse) updates) => super.copyWith((message) => updates(message as WifiClientSandboxResponse)) as WifiClientSandboxResponse;
  ...
  static $pb.PbList<WifiClientSandboxResponse> createRepeated() => $pb.PbList<WifiClientSandboxResponse>();
  @$core.pragma('dart2js:noInline')
  static WifiClientSandboxResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WifiClientSandboxResponse>(create);
...
class WifiWriteCalibrationRequest extends $pb.GeneratedMessage {
  factory WifiWriteCalibrationRequest({
    ...
    if (calibrationImage != null) {
      $result.calibrationImage = calibrationImage;
    }
    return $result;
  }
  WifiWriteCalibrationRequest._() : super();
  factory WifiWriteCalibrationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WifiWriteCalibrationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WifiWriteCalibrationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'calibrationImage', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WifiWriteCalibrationRequest clone() => WifiWriteCalibrationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WifiWriteCalibrationRequest copyWith(void Function(WifiWriteCalibrationRequest) updates) => super.copyWith((message) => updates(message as WifiWriteCalibrationRequest)) as WifiWriteCalibrationRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static WifiWriteCalibrationRequest create() => WifiWriteCalibrationRequest._();
  WifiWriteCalibrationRequest createEmptyInstance() => create();
  static $pb.PbList<WifiWriteCalibrationRequest> createRepeated() => $pb.PbList<WifiWriteCalibrationRequest>();
  @$core.pragma('dart2js:noInline')
  static WifiWriteCalibrationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WifiWriteCalibrationRequest>(create);
  static WifiWriteCalibrationRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get calibrationImage => $_getN(0);
  @$pb.TagNumber(1)
  set calibrationImage($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasCalibrationImage() => $_has(0);
  @$pb.TagNumber(1)
  void clearCalibrationImage() => clearField(1);
}
...
class WifiClientSandboxStatus extends $pb.GeneratedMessage {
  ...
  WifiClientSandboxStatus._() : super();
  factory WifiClientSandboxStatus.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WifiClientSandboxStatus.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WifiClientSandboxStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WifiClientSandboxStatus clone() => WifiClientSandboxStatus()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WifiClientSandboxStatus copyWith(void Function(WifiClientSandboxStatus) updates) => super.copyWith((message) => updates(message as WifiClientSandboxStatus)) as WifiClientSandboxStatus;
  ...
  static $pb.PbList<WifiClientSandboxStatus> createRepeated() => $pb.PbList<WifiClientSandboxStatus>();
  @$core.pragma('dart2js:noInline')
  static WifiClientSandboxStatus getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WifiClientSandboxStatus>(create);
  ...
  @$pb.TagNumber(2)
  set sandbox($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasSandbox() => $_has(1);
  @$pb.TagNumber(2)
  void clearSandbox() => clearField(2);

  @$pb.TagNumber(3)
  $core.bool get sandboxed => $_getBF(2);
  @$pb.TagNumber(3)
  set sandboxed($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSandboxed() => $_has(2);
  @$pb.TagNumber(3)
  void clearSandboxed() => clearField(3);
}
...
class GetLogResponse_Logs extends $pb.GeneratedMessage {
  factory GetLogResponse_Logs({
    ...
    if (debugNetsys0sec != null) {
      $result.debugNetsys0sec = debugNetsys0sec;
    }
    if (debugNetsys2sec != null) {
      $result.debugNetsys2sec = debugNetsys2sec;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetLogResponse.Logs', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ...
    ..aOS(5, _omitFieldNames ? '' : 'debugNetsys0sec', protoName: 'debug_netsys_0sec')
    ..aOS(6, _omitFieldNames ? '' : 'debugNetsys2sec', protoName: 'debug_netsys_2sec')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set debugNetsys0sec($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasDebugNetsys0sec() => $_has(4);
  @$pb.TagNumber(5)
  void clearDebugNetsys0sec() => clearField(5);

  @$pb.TagNumber(6)
  $core.String get debugNetsys2sec => $_getSZ(5);
  @$pb.TagNumber(6)
  set debugNetsys2sec($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasDebugNetsys2sec() => $_has(5);
  @$pb.TagNumber(6)
  void clearDebugNetsys2sec() => clearField(6);
}
...
class GetPingResponse_ResultsEntry extends $pb.GeneratedMessage {
  ...
  GetPingResponse_ResultsEntry._() : super();
  factory GetPingResponse_ResultsEntry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPingResponse_ResultsEntry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPingResponse.ResultsEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'key')
    ..aOM<$4.PingResult>(2, _omitFieldNames ? '' : 'value', subBuilder: $4.PingResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetPingResponse_ResultsEntry clone() => GetPingResponse_ResultsEntry()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetPingResponse_ResultsEntry copyWith(void Function(GetPingResponse_ResultsEntry) updates) => super.copyWith((message) => updates(message as GetPingResponse_ResultsEntry)) as GetPingResponse_ResultsEntry;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetPingResponse_ResultsEntry create() => GetPingResponse_ResultsEntry._();
  GetPingResponse_ResultsEntry createEmptyInstance() => create();
  static $pb.PbList<GetPingResponse_ResultsEntry> createRepeated() => $pb.PbList<GetPingResponse_ResultsEntry>();
  @$core.pragma('dart2js:noInline')
  static GetPingResponse_ResultsEntry getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPingResponse_ResultsEntry>(create);
  ...
  @$pb.TagNumber(2)
  $4.PingResult get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($4.PingResult v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $4.PingResult ensureValue() => $_ensure(1);
}
...
class GetPingResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPingResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..pc<GetPingResponse_ResultsEntry>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: GetPingResponse_ResultsEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<GetPingResponse_ResultsEntry> get results => $_getList(0);
}
...
class PingHostResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PingHostResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..aOM<$4.PingResult>(1, _omitFieldNames ? '' : 'result', subBuilder: $4.PingResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4.PingResult get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($4.PingResult v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasResult() => $_has(0);
  @$pb.TagNumber(1)
  void clearResult() => clearField(1);
  @$pb.TagNumber(1)
  $4.PingResult ensureResult() => $_ensure(0);
}

class GetStatusRequest extends $pb.GeneratedMessage {
  factory GetStatusRequest({
    $11.RouterRole? routerRole,
  }) {
    final $result = create();
    if (routerRole != null) {
      $result.routerRole = routerRole;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..e<$11.RouterRole>(1, _omitFieldNames ? '' : 'routerRole', $pb.PbFieldType.OE, defaultOrMaker: $11.RouterRole.UNSPECIFIED, valueOf: $11.RouterRole.valueOf, enumValues: $11.RouterRole.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.RouterRole get routerRole => $_getN(0);
  @$pb.TagNumber(1)
  set routerRole($11.RouterRole v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRouterRole() => $_has(0);
  @$pb.TagNumber(1)
  void clearRouterRole() => clearField(1);
}
...
class GetConnectionsResponse_ServicesEntry extends $pb.GeneratedMessage {
  ...
  GetConnectionsResponse_ServicesEntry._() : super();
  factory GetConnectionsResponse_ServicesEntry.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetConnectionsResponse_ServicesEntry.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetConnectionsResponse.ServicesEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'key')
    ..aOM<GetConnectionsResponse_ServiceConnection>(2, _omitFieldNames ? '' : 'value', subBuilder: GetConnectionsResponse_ServiceConnection.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetConnectionsResponse_ServicesEntry clone() => GetConnectionsResponse_ServicesEntry()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetConnectionsResponse_ServicesEntry copyWith(void Function(GetConnectionsResponse_ServicesEntry) updates) => super.copyWith((message) => updates(message as GetConnectionsResponse_ServicesEntry)) as GetConnectionsResponse_ServicesEntry;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetConnectionsResponse_ServicesEntry create() => GetConnectionsResponse_ServicesEntry._();
  GetConnectionsResponse_ServicesEntry createEmptyInstance() => create();
  static $pb.PbList<GetConnectionsResponse_ServicesEntry> createRepeated() => $pb.PbList<GetConnectionsResponse_ServicesEntry>();
  @$core.pragma('dart2js:noInline')
  static GetConnectionsResponse_ServicesEntry getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetConnectionsResponse_ServicesEntry>(create);
  ...
  @$pb.TagNumber(2)
  set value(GetConnectionsResponse_ServiceConnection v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
...
class GetConnectionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetConnectionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..pc<GetConnectionsResponse_ServicesEntry>(1, _omitFieldNames ? '' : 'services', $pb.PbFieldType.PM, subBuilder: GetConnectionsResponse_ServicesEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<GetConnectionsResponse_ServicesEntry> get services => $_getList(0);
}
...
class SetTrustedKeysRequest extends $pb.GeneratedMessage {
  factory SetTrustedKeysRequest({
    $core.Iterable<$3.PublicKey>? keys,
  }) {
    final $result = create();
    if (keys != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetTrustedKeysRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..pc<$3.PublicKey>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $3.PublicKey.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$3.PublicKey> get keys => $_getList(0);
}
...
class UpdateRequest extends $pb.GeneratedMessage {
  factory UpdateRequest({
    ...
    if (scheduleReboot != null) {
      $result.scheduleReboot = scheduleReboot;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(1)
  set scheduleReboot($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasScheduleReboot() => $_has(0);
  @$pb.TagNumber(1)
  void clearScheduleReboot() => clearField(1);
}
...
class GetNetworkInterfacesResponse extends $pb.GeneratedMessage {
  factory GetNetworkInterfacesResponse({
    $core.Iterable<$4.NetworkInterface>? networkInterfaces,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetNetworkInterfacesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..pc<$4.NetworkInterface>(1006, _omitFieldNames ? '' : 'networkInterfaces', $pb.PbFieldType.PM, subBuilder: $4.NetworkInterface.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1006)
  $core.List<$4.NetworkInterface> get networkInterfaces => $_getList(0);
}
...
class GetLocationResponse extends $pb.GeneratedMessage {
  factory GetLocationResponse({
    ...
    if (verticalSpeedMps != null) {
      $result.verticalSpeedMps = verticalSpeedMps;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetLocationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..aOM<$4.LLAPosition>(1, _omitFieldNames ? '' : 'lla', subBuilder: $4.LLAPosition.create)
    ...
    ..a<$core.double>(5, _omitFieldNames ? '' : 'horizontalSpeedMps', $pb.PbFieldType.OD)
    ..a<$core.double>(6, _omitFieldNames ? '' : 'verticalSpeedMps', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4.LLAPosition get lla => $_getN(0);
  @$pb.TagNumber(1)
  set lla($4.LLAPosition v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLla() => $_has(0);
  @$pb.TagNumber(1)
  void clearLla() => clearField(1);
  @$pb.TagNumber(1)
  $4.LLAPosition ensureLla() => $_ensure(0);
  ...
  @$pb.TagNumber(5)
  set horizontalSpeedMps($core.double v) { $_setDouble(3, v); }
  @$pb.TagNumber(5)
  $core.bool hasHorizontalSpeedMps() => $_has(3);
  @$pb.TagNumber(5)
  void clearHorizontalSpeedMps() => clearField(5);

  @$pb.TagNumber(6)
  $core.double get verticalSpeedMps => $_getN(4);
  @$pb.TagNumber(6)
  set verticalSpeedMps($core.double v) { $_setDouble(4, v); }
  @$pb.TagNumber(6)
  $core.bool hasVerticalSpeedMps() => $_has(4);
  @$pb.TagNumber(6)
  void clearVerticalSpeedMps() => clearField(6);
}
...
class DishSetEmcRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(24)
  set countryCodeOverride($core.int v) { $_setUnsignedInt32(20, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set txDutyCycleOverride($core.int v) { $_setSignedInt32(21, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(26)
  set rxDutyCycleOverride($core.int v) { $_setSignedInt32(22, v); }
  @$pb.TagNumber(26)
  ...
  @$pb.TagNumber(27)
  set eirpLegalLimitDbwOverride($core.double v) { $_setDouble(23, v); }
  @$pb.TagNumber(27)
  ...
  @$pb.TagNumber(28)
  set eirpAdjustmentDb($core.double v) { $_setDouble(24, v); }
  @$pb.TagNumber(28)
...
class DishGetEmcResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(62)
  set countryCodeOverride($core.int v) { $_setUnsignedInt32(40, v); }
  @$pb.TagNumber(62)
  ...
  @$pb.TagNumber(63)
  set maxPointingDistance($core.double v) { $_setDouble(41, v); }
  @$pb.TagNumber(63)
  ...
  @$pb.TagNumber(64)
  set distanceScalingFactor($core.double v) { $_setDouble(42, v); }
  @$pb.TagNumber(64)
  ...
  @$pb.TagNumber(65)
  set txDutyCycleOverride($core.int v) { $_setSignedInt32(43, v); }
  @$pb.TagNumber(65)
  ...
  @$pb.TagNumber(66)
  set rxDutyCycleOverride($core.int v) { $_setSignedInt32(44, v); }
  @$pb.TagNumber(66)
  ...
  @$pb.TagNumber(67)
  set txTimeMs($core.double v) { $_setFloat(45, v); }
  @$pb.TagNumber(67)
  ...
  @$pb.TagNumber(68)
  set rxTimeMs($core.double v) { $_setFloat(46, v); }
  @$pb.TagNumber(68)
  ...
  @$pb.TagNumber(69)
  set eirpLegalLimitDbw($core.double v) { $_setDouble(47, v); }
  @$pb.TagNumber(69)
  ...
  @$pb.TagNumber(70)
  set eirpLegalLimitDbwOverride($core.double v) { $_setDouble(48, v); }
  @$pb.TagNumber(70)
  ...
  @$pb.TagNumber(71)
  set eirpAdjustmentDb($core.double v) { $_setDouble(49, v); }
  @$pb.TagNumber(71)
  ...
  @$pb.TagNumber(72)
  set eirpPredictedDbw($core.double v) { $_setDouble(50, v); }
  @$pb.TagNumber(72)
...
class SetPerVehicleConfigResponse extends $pb.GeneratedMessage {
  ...
  SetPerVehicleConfigResponse._() : super();
  factory SetPerVehicleConfigResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetPerVehicleConfigResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetPerVehicleConfigResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetPerVehicleConfigResponse clone() => SetPerVehicleConfigResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetPerVehicleConfigResponse copyWith(void Function(SetPerVehicleConfigResponse) updates) => super.copyWith((message) => updates(message as SetPerVehicleConfigResponse)) as SetPerVehicleConfigResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SetPerVehicleConfigResponse create() => SetPerVehicleConfigResponse._();
  SetPerVehicleConfigResponse createEmptyInstance() => create();
  static $pb.PbList<SetPerVehicleConfigResponse> createRepeated() => $pb.PbList<SetPerVehicleConfigResponse>();
  @$core.pragma('dart2js:noInline')
  static SetPerVehicleConfigResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetPerVehicleConfigResponse>(create);
...
class DishGetDiagnosticsResponse_Alerts extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set obstructed($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(10)
...
class DishGetDiagnosticsResponse_Location extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set gpsTimeS($core.double v) { $_setDouble(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasGpsTimeS() => $_has(6);
  @$pb.TagNumber(7)
  void clearGpsTimeS() => clearField(7);
}
...
class DishGetDiagnosticsResponse_AlignmentStats extends $pb.GeneratedMessage {
  ...
  DishGetDiagnosticsResponse_AlignmentStats._() : super();
  factory DishGetDiagnosticsResponse_AlignmentStats.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DishGetDiagnosticsResponse_AlignmentStats.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DishGetDiagnosticsResponse.AlignmentStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'boresightAzimuthDeg', $pb.PbFieldType.OF)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'boresightElevationDeg', $pb.PbFieldType.OF)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'desiredBoresightAzimuthDeg', $pb.PbFieldType.OF)
    ..a<$core.double>(4, _omitFieldNames ? '' : 'desiredBoresightElevationDeg', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DishGetDiagnosticsResponse_AlignmentStats clone() => DishGetDiagnosticsResponse_AlignmentStats()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DishGetDiagnosticsResponse_AlignmentStats copyWith(void Function(DishGetDiagnosticsResponse_AlignmentStats) updates) => super.copyWith((message) => updates(message as DishGetDiagnosticsResponse_AlignmentStats)) as DishGetDiagnosticsResponse_AlignmentStats;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DishGetDiagnosticsResponse_AlignmentStats create() => DishGetDiagnosticsResponse_AlignmentStats._();
  DishGetDiagnosticsResponse_AlignmentStats createEmptyInstance() => create();
  static $pb.PbList<DishGetDiagnosticsResponse_AlignmentStats> createRepeated() => $pb.PbList<DishGetDiagnosticsResponse_AlignmentStats>();
  @$core.pragma('dart2js:noInline')
  static DishGetDiagnosticsResponse_AlignmentStats getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DishGetDiagnosticsResponse_AlignmentStats>(create);
  static DishGetDiagnosticsResponse_AlignmentStats? _defaultInstance;

  @$pb.TagNumber(1)
  $core.double get boresightAzimuthDeg => $_getN(0);
  @$pb.TagNumber(1)
  set boresightAzimuthDeg($core.double v) { $_setFloat(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasBoresightAzimuthDeg() => $_has(0);
  @$pb.TagNumber(1)
  void clearBoresightAzimuthDeg() => clearField(1);

  @$pb.TagNumber(2)
  $core.double get boresightElevationDeg => $_getN(1);
  @$pb.TagNumber(2)
  set boresightElevationDeg($core.double v) { $_setFloat(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasBoresightElevationDeg() => $_has(1);
  @$pb.TagNumber(2)
  void clearBoresightElevationDeg() => clearField(2);

  @$pb.TagNumber(3)
  $core.double get desiredBoresightAzimuthDeg => $_getN(2);
  @$pb.TagNumber(3)
  set desiredBoresightAzimuthDeg($core.double v) { $_setFloat(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasDesiredBoresightAzimuthDeg() => $_has(2);
  @$pb.TagNumber(3)
  void clearDesiredBoresightAzimuthDeg() => clearField(3);

  @$pb.TagNumber(4)
  $core.double get desiredBoresightElevationDeg => $_getN(3);
  @$pb.TagNumber(4)
  set desiredBoresightElevationDeg($core.double v) { $_setFloat(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasDesiredBoresightElevationDeg() => $_has(3);
  @$pb.TagNumber(4)
  void clearDesiredBoresightElevationDeg() => clearField(4);
}
...
class DishGetDiagnosticsResponse extends $pb.GeneratedMessage {
  factory DishGetDiagnosticsResponse({
    ...
    $core.bool? stowed,
    $core.Iterable<DishGetDiagnosticsResponse_TestResultCode>? hardwareSelfTestCodes,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DishGetDiagnosticsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ...
    ..aOM<DishGetDiagnosticsResponse_AlignmentStats>(9, _omitFieldNames ? '' : 'alignmentStats', subBuilder: DishGetDiagnosticsResponse_AlignmentStats.create)
    ..aOB(10, _omitFieldNames ? '' : 'stowed')
    ..pc<DishGetDiagnosticsResponse_TestResultCode>(11, _omitFieldNames ? '' : 'hardwareSelfTestCodes', $pb.PbFieldType.KE, valueOf: DishGetDiagnosticsResponse_TestResultCode.valueOf, enumValues: DishGetDiagnosticsResponse_TestResultCode.values, defaultEnumValue: DishGetDiagnosticsResponse_TestResultCode.GENERAL)
  ...
  @$pb.TagNumber(9)
  set alignmentStats(DishGetDiagnosticsResponse_AlignmentStats v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAlignmentStats() => $_has(8);
  @$pb.TagNumber(9)
  void clearAlignmentStats() => clearField(9);
  @$pb.TagNumber(9)
  DishGetDiagnosticsResponse_AlignmentStats ensureAlignmentStats() => $_ensure(8);

  @$pb.TagNumber(10)
  $core.bool get stowed => $_getBF(9);
  @$pb.TagNumber(10)
  set stowed($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasStowed() => $_has(9);
  @$pb.TagNumber(10)
  void clearStowed() => clearField(10);

  @$pb.TagNumber(11)
  $core.List<DishGetDiagnosticsResponse_TestResultCode> get hardwareSelfTestCodes => $_getList(10);

  @$pb.TagNumber(14)
  $core.bool get overageRateLimited => $_getBF(11);
  @$pb.TagNumber(14)
  set overageRateLimited($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(14)
  $core.bool hasOverageRateLimited() => $_has(11);
  @$pb.TagNumber(14)
  void clearOverageRateLimited() => clearField(14);
}
...
class GetGoroutineStackTracesRequest extends $pb.GeneratedMessage {
  ...
  GetGoroutineStackTracesRequest._() : super();
  factory GetGoroutineStackTracesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetGoroutineStackTracesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetGoroutineStackTracesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetGoroutineStackTracesRequest clone() => GetGoroutineStackTracesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetGoroutineStackTracesRequest copyWith(void Function(GetGoroutineStackTracesRequest) updates) => super.copyWith((message) => updates(message as GetGoroutineStackTracesRequest)) as GetGoroutineStackTracesRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetGoroutineStackTracesRequest create() => GetGoroutineStackTracesRequest._();
  GetGoroutineStackTracesRequest createEmptyInstance() => create();
  static $pb.PbList<GetGoroutineStackTracesRequest> createRepeated() => $pb.PbList<GetGoroutineStackTracesRequest>();
  @$core.pragma('dart2js:noInline')
  static GetGoroutineStackTracesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetGoroutineStackTracesRequest>(create);
...
class GetGoroutineStackTracesResponse extends $pb.GeneratedMessage {
  ...
  GetGoroutineStackTracesResponse._() : super();
  factory GetGoroutineStackTracesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetGoroutineStackTracesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetGoroutineStackTracesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'SpaceX.API.Device'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetGoroutineStackTracesResponse clone() => GetGoroutineStackTracesResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetGoroutineStackTracesResponse copyWith(void Function(GetGoroutineStackTracesResponse) updates) => super.copyWith((message) => updates(message as GetGoroutineStackTracesResponse)) as GetGoroutineStackTracesResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetGoroutineStackTracesResponse create() => GetGoroutineStackTracesResponse._();
  GetGoroutineStackTracesResponse createEmptyInstance() => create();
  static $pb.PbList<GetGoroutineStackTracesResponse> createRepeated() => $pb.PbList<GetGoroutineStackTracesResponse>();
  @$core.pragma('dart2js:noInline')
  static GetGoroutineStackTracesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetGoroutineStackTracesResponse>(create);
  static GetGoroutineStackTracesResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get stackTraces => $_getSZ(0);
  @$pb.TagNumber(1)
  set stackTraces($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasStackTraces() => $_has(0);
  @$pb.TagNumber(1)
  void clearStackTraces() => clearField(1);
}
