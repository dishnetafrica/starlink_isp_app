...
class PositionSource extends $pb.ProtobufEnum {
  ...
  static const PositionSource GNC_FUSED = PositionSource._(6, _omitEnumNames ? '' : 'GNC_FUSED');
  static const PositionSource GNC_BAD_SAT = PositionSource._(7, _omitEnumNames ? '' : 'GNC_BAD_SAT');
  static const PositionSource GNC_GPS = PositionSource._(8, _omitEnumNames ? '' : 'GNC_GPS');
  static const PositionSource GNC_PNT = PositionSource._(9, _omitEnumNames ? '' : 'GNC_PNT');
  static const PositionSource GNC_STATIC = PositionSource._(10, _omitEnumNames ? '' : 'GNC_STATIC');
...
class DishGetDiagnosticsResponse_TestResultCode extends $pb.ProtobufEnum {
  static const DishGetDiagnosticsResponse_TestResultCode GENERAL = DishGetDiagnosticsResponse_TestResultCode._(0, _omitEnumNames ? '' : 'GENERAL');
  static const DishGetDiagnosticsResponse_TestResultCode BOOT_UP = DishGetDiagnosticsResponse_TestResultCode._(1, _omitEnumNames ? '' : 'BOOT_UP');
  static const DishGetDiagnosticsResponse_TestResultCode CPU_VOLTAGE = DishGetDiagnosticsResponse_TestResultCode._(2, _omitEnumNames ? '' : 'CPU_VOLTAGE');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_AAP_CS = DishGetDiagnosticsResponse_TestResultCode._(3, _omitEnumNames ? '' : 'DBF_AAP_CS');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_NUM_FEMS = DishGetDiagnosticsResponse_TestResultCode._(4, _omitEnumNames ? '' : 'DBF_NUM_FEMS');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_READ_ERRORS = DishGetDiagnosticsResponse_TestResultCode._(5, _omitEnumNames ? '' : 'DBF_READ_ERRORS');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_T_DIE_0 = DishGetDiagnosticsResponse_TestResultCode._(6, _omitEnumNames ? '' : 'DBF_T_DIE_0');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_T_DIE_1 = DishGetDiagnosticsResponse_TestResultCode._(7, _omitEnumNames ? '' : 'DBF_T_DIE_1');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_T_DIE_0_VALID = DishGetDiagnosticsResponse_TestResultCode._(8, _omitEnumNames ? '' : 'DBF_T_DIE_0_VALID');
  static const DishGetDiagnosticsResponse_TestResultCode DBF_T_DIE_1_VALID = DishGetDiagnosticsResponse_TestResultCode._(9, _omitEnumNames ? '' : 'DBF_T_DIE_1_VALID');
  static const DishGetDiagnosticsResponse_TestResultCode ETH_PRIME = DishGetDiagnosticsResponse_TestResultCode._(10, _omitEnumNames ? '' : 'ETH_PRIME');
  static const DishGetDiagnosticsResponse_TestResultCode EIRP = DishGetDiagnosticsResponse_TestResultCode._(11, _omitEnumNames ? '' : 'EIRP');
  static const DishGetDiagnosticsResponse_TestResultCode FEM_CUT = DishGetDiagnosticsResponse_TestResultCode._(12, _omitEnumNames ? '' : 'FEM_CUT');
  static const DishGetDiagnosticsResponse_TestResultCode FUSE_AVS = DishGetDiagnosticsResponse_TestResultCode._(13, _omitEnumNames ? '' : 'FUSE_AVS');
  static const DishGetDiagnosticsResponse_TestResultCode GPS = DishGetDiagnosticsResponse_TestResultCode._(14, _omitEnumNames ? '' : 'GPS');
  static const DishGetDiagnosticsResponse_TestResultCode IMU = DishGetDiagnosticsResponse_TestResultCode._(15, _omitEnumNames ? '' : 'IMU');
  static const DishGetDiagnosticsResponse_TestResultCode PHY = DishGetDiagnosticsResponse_TestResultCode._(16, _omitEnumNames ? '' : 'PHY');
  static const DishGetDiagnosticsResponse_TestResultCode SCP_ERROR = DishGetDiagnosticsResponse_TestResultCode._(17, _omitEnumNames ? '' : 'SCP_ERROR');
  static const DishGetDiagnosticsResponse_TestResultCode TEMPERATURE = DishGetDiagnosticsResponse_TestResultCode._(18, _omitEnumNames ? '' : 'TEMPERATURE');
  static const DishGetDiagnosticsResponse_TestResultCode VTSENS = DishGetDiagnosticsResponse_TestResultCode._(19, _omitEnumNames ? '' : 'VTSENS');

  static const $core.List<DishGetDiagnosticsResponse_TestResultCode> values = <DishGetDiagnosticsResponse_TestResultCode> [
    GENERAL,
    BOOT_UP,
    CPU_VOLTAGE,
    DBF_AAP_CS,
  ...
  static final $core.Map<$core.int, DishGetDiagnosticsResponse_TestResultCode> _byValue = $pb.ProtobufEnum.initByValue(values);
  static DishGetDiagnosticsResponse_TestResultCode? valueOf($core.int value) => _byValue[value];

  const DishGetDiagnosticsResponse_TestResultCode._($core.int v, $core.String n) : super(v, n);
}
...
class DishGetDiagnosticsResponse_DisablementCode extends $pb.ProtobufEnum {
  ...
  static const DishGetDiagnosticsResponse_DisablementCode MOVING_TOO_FAST_FOR_POLICY = DishGetDiagnosticsResponse_DisablementCode._(14, _omitEnumNames ? '' : 'MOVING_TOO_FAST_FOR_POLICY');
  static const DishGetDiagnosticsResponse_DisablementCode UNDER_AVIATION_FLYOVER_LIMITS = DishGetDiagnosticsResponse_DisablementCode._(15, _omitEnumNames ? '' : 'UNDER_AVIATION_FLYOVER_LIMITS');
  static const DishGetDiagnosticsResponse_DisablementCode BLOCKED_AREA = DishGetDiagnosticsResponse_DisablementCode._(16, _omitEnumNames ? '' : 'BLOCKED_AREA');
